    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("  1 - Trial (15 dias, 1 dispositivo)");
                Console.WriteLine("  2 - Standard (R$ 99,00, 1 dispositivo)");
                Console.WriteLine("  3 - Pro (R$ 199,00, 3 dispositivos)");
                Console.WriteLine("  4 - Enterprise (A partir de R$ 499,00, ilimitado)");
