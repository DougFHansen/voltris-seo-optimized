        ...
        public bool IsTrialExpired()
        {
            try
            {
                ...
                if (expired)
                {
                    ...
                    // Sincronizar com servidor quando trial expira
                    try
                    {
                        if (EnterpriseService.Instance != null)
                        {
                            _ = Task.Run(async () => await EnterpriseService.Instance.SyncLicenseStatusAsync());
                        }
                    }
                    catch { }
                }
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dir))
                {
                    ...
                    catch (UnauthorizedAccessException)
                    {
                        ...
                        return; // Não continuar se não puder criar diretório
                    }
                    catch (Exception ex)
                    {
