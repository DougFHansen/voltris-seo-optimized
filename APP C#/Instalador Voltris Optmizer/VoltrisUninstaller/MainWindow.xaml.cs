...
namespace VoltrisUninstaller
{
    public partial class MainWindow : Window
    {
        ...
        {
            // ForÃ§ar o ScrollBar a aparecer
            ...
            // Aplicar estilo apÃ³s o Loaded para garantir que os recursos estejam disponÃ­veis
            this.Loaded += (s, e) =>
            {
                try
                {
                    // Aplicar estilo do ScrollViewer se disponÃ­vel
                ...
                {
                    // Tentar mÃ©todo alternativo com reflection
                    try
                    {
        ...
        private void Header_MouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            if (e.ChangedButton == System.Windows.Input.MouseButton.Left && e.ButtonState == System.Windows.Input.MouseButtonState.Pressed)
            {
                ...
                {
                    // Ignorar erros de DragMove (pode ocorrer se o mouse nÃ£o estiver pressionado)
                }
            }
        }
