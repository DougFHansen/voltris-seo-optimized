...
namespace VoltrisOptimizer.Services
{
    ...
    public class SmartAIExecutor
    {
        ...
        private void InitializeActions()
        {
            ...
            {
                _logger.LogInfo("[SmartAI] Ativando modo gamer automaticamente");
                
                try
                {
                    var gamer = App.GamerOptimizer;
                    if (gamer != null)
                    {
                        if (gamer.IsGamerModeActive)
                        {
                            return "ℹ️ Modo Gamer já está ativo!";
                        }
                        
                        var success = await gamer.ActivateGamerModeAsync();
                    ...
                    return "❌ Serviço de otimização gamer não disponível.";
                }
                catch (Exception ex)
                {
            ...
            {
                _logger.LogInfo("[SmartAI] Desativando modo gamer automaticamente");
                ...
                try
                {
                    ...
                    if (gamer != null)
                    {
                        ...
                        var success = await gamer.DeactivateGamerModeAsync();
