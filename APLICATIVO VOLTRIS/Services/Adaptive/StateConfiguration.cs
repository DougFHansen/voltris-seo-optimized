...
namespace VoltrisOptimizer.Services.Adaptive
{
    ...
    {
        None,            // Nenhuma otimização (recovery mode)
        Conservative,    // Otimizações leves
        Moderate,        // Otimizações padrão
        Aggressive,      // Otimizações máximas
        ThermalSafe,     // Priorizar temperatura baixa
        MemoryOptimized  // Priorizar uso de memória
    }
