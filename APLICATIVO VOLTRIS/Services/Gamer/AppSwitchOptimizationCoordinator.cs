...
namespace VoltrisOptimizer.Services.Gamer
{
    ...
    public class AppSwitchOptimizationCoordinator : IDisposable
    {
        ...
        private void OnAppSwitchDetected(object? sender, AppSwitchEventArgs e)
        {
            try
            {
                _logger.LogInfo($"[AppSwitchCoord] Troca detectada: {e.FromProcessName} -> {e.ToProcessName}");
        ...
        private void HandlePriorityOptimization(AppSwitchEventArgs e)
        {
            try
            {
                ...
                _logger.LogInfo("[AppSwitchCoord] Otimização de prioridades coordenada");
            }
            catch (Exception ex)
            {
        ...
        private void HandleResourceOptimization(AppSwitchEventArgs e)
        {
            try
            {
                ...
                _logger.LogInfo("[AppSwitchCoord] Otimização de recursos coordenada");
            }
            catch (Exception ex)
            {
        ...
        private void HandleBackgroundOptimization(AppSwitchEventArgs e)
        {
            try
            {
                ...
                _logger.LogInfo("[AppSwitchCoord] Otimização de background coordenada");
            }
            catch (Exception ex)
            {
        ...
        private void HandleLatencyOptimization(AppSwitchEventArgs e)
        {
            try
            {
                ...
                _logger.LogInfo("[AppSwitchCoord] Otimização de latência coordenada");
            }
            catch (Exception ex)
            {
        ...
        private void HandleNotificationBlocking(AppSwitchEventArgs e)
        {
            try
            {
                ...
                _logger.LogInfo("[AppSwitchCoord] Bloqueio de notificações reforçado");
            }
            catch (Exception ex)
            {
