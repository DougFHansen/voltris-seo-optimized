...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.voltris.com.br/otimizar-windows-para-edicao-de-video',
  },
  openGraph: {
    title: 'Workstation de Elite: Otimize seu PC para Edição de Vídeo',
    description: 'Renderize mais rápido e edite sem travamentos. Transforme seu Windows em uma estação de trabalho profissional.',
    type: 'article',
    url: 'https://www.voltris.com.br/otimizar-windows-para-edicao-de-video',
    images: [{ url: '/images/og-video-editing-optimization.jpg' }],
  },
};
