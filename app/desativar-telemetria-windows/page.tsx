    ...
    const contentSections = [
      ...
      `
        ...
        <ul class="space-y-4 text-gray-600">
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Disable Keyloggers:** Bloqueia a coleta de padrões de escrita e voz.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Block Hosts:** Impede o PC de se conectar aos servidores de análise e anúncios da Microsoft via arquivo de Hosts editado.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **App Integrity:** Melhora a segurança sem precisar monitorar seu comportamento.</li>
        </ul>
      `
        }
    ];
