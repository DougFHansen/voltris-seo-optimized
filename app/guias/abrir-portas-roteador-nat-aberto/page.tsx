...
export default function RouterPortGuide() {
    ...
    const contentSections = [
      ...
      `
        ...
        <p class="text-gray-700 mb-3 mt-6"><strong>No Xbox Series X|S:</strong></p>
        <ol class="list-decimal list-inside text-gray-700 space-y-2 ml-4">
        ...
        <p class="text-gray-700 mb-3 mt-6"><strong>No PC (Steam):</strong></p>
        <ol class="list-decimal list-inside text-gray-700 space-y-2 ml-4">
          <li>Abra a Steam → Vá em Ajuda → Informações do Sistema.</li>
          <li>Procure por "Network" - deve aparecer <strong>"NAT: Open"</strong>.</li>
        </ol>
        
        <p class="text-gray-700 mb-3 mt-6"><strong>Em jogos específicos (Warzone, GTA):</strong></p>
      ...
      `
        ...
        <div class="space-y-6 mt-4">
          <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
            ...
            <p class="text-gray-700 mb-3">VPNs especializadas em jogos redirecionam o tráfego para servidores otimizados, potencialmente contornando problemas de NAT restrito:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
            ...
            <p class="text-gray-700 mb-3">Soluções que encapsulam tráfego UDP em TCP para contornar firewalls restritivos:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <div class="bg-amber-900/10 p-5 rounded-xl border border-amber-500/20">
            ...
            <p class="text-gray-700 mb-3">Soluções definitivas para problemas de NAT em redes complexas:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-2 ml-4">
    ...
    const advancedContentSections = [
        {
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
                ...
                <p class="text-gray-700 text-sm">Capaz de identificar e filtrar tráfego com base no conteúdo do pacote, não apenas cabeçalhos</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 mt-2 text-sm">
              ...
              <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
                ...
                <p class="text-gray-700 text-sm">Controle granular sobre aplicações mesmo que usem portas comuns</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 mt-2 text-sm">
        ...
        },
        {
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
              <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Responsáveis por encontrar e agrupar jogadores:</p>
              ...
              <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Executam a lógica do jogo e sincronização:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
        ...
        },
        {
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-rose-900/10 p-5 rounded-xl border border-rose-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Distributed Denial of Service contra servidores ou jogadores individuais:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div class="bg-amber-900/10 p-5 rounded-xl border border-amber-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Vazamento acidental de informações pessoais:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
