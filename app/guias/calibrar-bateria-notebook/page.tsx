    ...
    const contentSections = [
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700">Siga este procedimento para resetar o sensor:</p>
