  ...
  const contentSections = [
        ...
        <div class="space-y-6 bg-gray-900 border border-gray-700 p-6 rounded-xl">
            ...
            <div class="mt-4 grid gap-4">
                <div class="border-l-4 border-red-500 pl-4">
                    ...
                    <span class="text-gray-700 text-sm">Seu driver de Wi-Fi ou Ethernet está monopolizando a CPU. Atualize o driver da placa de rede ou, se possível, use cabo Ethernet em vez de Wi-Fi. Desative "Energy Efficient Ethernet" no Gerenciador de Dispositivos.</span>
                </div>
                <div class="border-l-4 border-green-500 pl-4">
                    <strong class="text-green-400 block">nvlddmkm.sys (NVIDIA)</strong>
                    <span class="text-gray-700 text-sm">Driver da GPU causando lag. Use o DDU (Display Driver Uninstaller) para limpar tudo e instale a versão "Studio Driver" (mais estável) em vez da "Game Ready". Ative o modo "MSI Mode" (Message Signaled Interrupts) usando a ferramenta MSI Utility v3.</span>
                </div>
                <div class="border-l-4 border-blue-500 pl-4">
                    <strong class="text-blue-400 block">storport.sys (HD/SSD)</strong>
                    <span class="text-gray-700 text-sm">Seu disco rígido está lento ou morrendo. Troque o cabo SATA ou verifique se o SSD está com firmware atualizado.</span>
                </div>
            </div>
        </div>
      `
    },
    {
      ...
      content: `
        ...
        <p class="text-gray-700 text-sm border-l-2 border-yellow-500 pl-4">
    ...
    },
    {
      ...
      content: `
        ...
        <p class="text-gray-700 text-xs mt-2 italic">
