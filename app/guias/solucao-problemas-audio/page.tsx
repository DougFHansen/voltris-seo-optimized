  ...
  const contentSections = [
    ...
    },
    {
      ...
      content: `
        ...
        <ol class="list-decimal list-inside text-gray-400 space-y-3 bg-gray-900/40 p-5 rounded-lg">
        ...
        <p class="text-gray-400 text-sm border-l-2 border-yellow-500 pl-4">
