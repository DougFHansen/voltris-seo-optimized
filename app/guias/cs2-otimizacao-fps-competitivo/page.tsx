...
export default function CS2Guide() {
    ...
    const contentSections = [
      ...
      `
        ...
        <div class="bg-[#0A0A0F] p-5 rounded-xl border border-white/5">
            ...
            <div class="mt-4 bg-red-900/20 border-l-4 border-red-500 p-3">
                ...
                <p class="text-gray-700 text-xs">-high (Causa instabilidade no Windows 11), -threads (O gerenciador do Source 2 é melhor que o manual), -freq (O jogo já pega o Hz do desktop).</p>
            </div>
        </div>
      `
        },
      ...
      `
        ...
        <div class="bg-black/50 p-4 rounded-xl border border-gray-700 font-mono text-xs text-gray-700 overflow-x-auto">
    ...
    const advancedContentSections = [
        ...
        <div class="bg-gray-800 p-4 rounded text-sm text-gray-700">
