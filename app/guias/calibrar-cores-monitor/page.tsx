    ...
    const contentSections = [
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700">O Windows tem uma ferramenta excelente escondida nos menus:</p>
        ...
        <div class="space-y-4">
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-700">Empresas como Samsung e Sony estão desenvolvendo tecnologia QD-OLED que combina os benefícios do OLED (contraste infinito) com os pontos quânticos (gama de cores ampliada). Essa tecnologia promete cobertura de 100% do espaço de cor DCI-P3 com brilho superior. Implementações comerciais estão previstas para 2026-2027, com adoção generalizada esperada para 2027-2029.</p>
            </div>
          </div>
