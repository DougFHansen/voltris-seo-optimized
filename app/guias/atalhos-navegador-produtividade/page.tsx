        ...
        <table class="w-full text-sm text-gray-400 border border-gray-700 rounded-lg overflow-hidden">
          ...
          <tbody>
            ...
            <tr class="border-t border-gray-700">
              ...
              <td class="p-3">Pesquisar em Abas Abertas</td>
              <td class="p-3">Encontre aquela aba perdida entre 50 abas!</td>
            </tr>
          </tbody>
        </table>
    ...
    },
    {
      ...
      content: `
        ...
        <ul class="list-disc list-inside text-gray-400 space-y-3 ml-4">
          ...
          <li><code>Ctrl + Shift + B</code> - Mostrar/Ocultar Barra de Favoritos</li>
      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
                ...
                <p class="text-gray-400 text-sm mb-3">Detecção de combinações de teclas:</p>
              ...
              <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
                ...
                <p class="text-gray-400 text-sm mb-3">Distribuição do evento para o handler correto:</p>
                <ul class="list-disc list-inside text-gray-400 space-y-1 text-sm">
      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 p-5 rounded-xl border border-cyan-500/30">
                ...
                <p class="text-gray-400 text-sm mb-3">Para pesquisadores e estudantes:</p>
                <ul class="list-disc list-inside text-gray-400 space-y-1 text-sm">
              ...
              <div class="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 p-5 rounded-xl border border-emerald-500/30">
                ...
                <p class="text-gray-400 text-sm mb-3">Para desenvolvedores e testadores:</p>
                <ul class="list-disc list-inside text-gray-400 space-y-1 text-sm">
      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-rose-900/10 p-5 rounded-xl border border-rose-500/20">
                ...
                <p class="text-gray-400 text-sm mb-3">Para desenvolvedores de testes:</p>
                <ul class="list-disc list-inside text-gray-400 space-y-1 text-sm">
              ...
              <div class="bg-amber-900/10 p-5 rounded-xl border border-amber-500/20">
                ...
                <p class="text-gray-400 text-sm mb-3">Para usuários avançados:</p>
                <ul class="list-disc list-inside text-gray-400 space-y-1 text-sm">
  ...
  const additionalContentSections = [
    {
      ...
      content: `
        <p class="mb-4 text-gray-400">A evolução dos atalhos de navegador acompanhou o desenvolvimento da web desde os primeiros navegadores gráficos até os poderosos motores modernos. Cada atalho foi meticulosamente projetado para otimizar a experiência do usuário e aumentar a produtividade.</p>
          ...
          <div class="space-y-4">
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Primeiro navegador com atalhos básicos como Ctrl+L para ir para a barra de endereço.</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Introduziu atalhos para navegação entre páginas e recarregamento.</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Padronizou muitos dos atalhos que usamos hoje, como Ctrl+T para nova aba.</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Expandiu o conjunto de atalhos para incluir mais funções de interface.</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Revolutionou a gestão de abas com atalhos mais sofisticados e integração com extensões.</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">Atalhos adaptativos e personalizáveis com base no comportamento do usuário.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <p class="mb-4 text-gray-400">Apesar da evolução, muitos atalhos permaneceram consistentes entre navegadores:</p>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">Ctrl+T</h5>
            <p class="text-sm text-gray-400">Consistente desde o Netscape Navigator para abrir nova aba.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">Ctrl+W</h5>
            <p class="text-sm text-gray-400">Padrão universal para fechar aba atual desde os anos 90.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">Ctrl+L</h5>
            <p class="text-sm text-gray-400">Foco na barra de endereço, mantido por mais de 30 anos.</p>
          </div>
        </div>
      `
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400">A escolha das combinações de teclas para atalhos não é aleatória. Cada combinação foi cuidadosamente projetada para maximizar a eficiência e minimizar o esforço físico do usuário.</p>
        
        <h4 class="text-white font-bold mb-3 mt-6">Princípios de Design de Atalhos</h4>
        <p class="mb-4 text-gray-400">Existem vários princípios fundamentais que guiam a criação de atalhos eficientes:</p>
        
        <div class="space-y-4">
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            <h5 class="font-bold text-red-400 mb-2">Memorabilidade</h5>
            <p class="text-gray-400 text-sm">As teclas usadas geralmente fazem associação com a função:</p>
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-400 text-sm">Combinações são projetadas para serem alcançadas com facilidade:</p>
            <ul class="list-disc list-inside text-gray-400 text-sm mt-2 space-y-1">
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-400 text-sm">Mantém padrões semelhantes em diferentes softwares:</p>
            <ul class="list-disc list-inside text-gray-400 text-sm mt-2 space-y-1">
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400">Atalhos de teclado são uma ferramenta crucial para acessibilidade, permitindo que pessoas com diferentes capacidades físicas utilizem navegadores da web de forma eficiente e independente.</p>
        
        <h4 class="text-white font-bold mb-3 mt-6">Atalhos e Acessibilidade</h4>
        <p class="mb-4 text-gray-400">Os atalhos de teclado desempenham um papel vital na inclusão digital:</p>
        ...
        <p class="mb-4 text-gray-400">As diretrizes internacionais de acessibilidade influenciam o design de atalhos:</p>
