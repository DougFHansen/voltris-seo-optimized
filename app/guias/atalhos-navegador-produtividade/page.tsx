      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Detecção de combinações de teclas:</p>
              ...
              <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Distribuição do evento para o handler correto:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 p-5 rounded-xl border border-cyan-500/30">
                ...
                <p class="text-gray-700 text-sm mb-3">Para pesquisadores e estudantes:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div class="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 p-5 rounded-xl border border-emerald-500/30">
                ...
                <p class="text-gray-700 text-sm mb-3">Para desenvolvedores e testadores:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
      ...
      content: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-rose-900/10 p-5 rounded-xl border border-rose-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Para desenvolvedores de testes:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div class="bg-amber-900/10 p-5 rounded-xl border border-amber-500/20">
                ...
                <p class="text-gray-700 text-sm mb-3">Para usuários avançados:</p>
                <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
  ...
  const additionalContentSections = [
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">A evolução dos atalhos de navegador acompanhou o desenvolvimento da web desde os primeiros navegadores gráficos até os poderosos motores modernos. Cada atalho foi meticulosamente projetado para otimizar a experiência do usuário e aumentar a produtividade.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-sm text-gray-700">Consistente desde o Netscape Navigator para abrir nova aba.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">Ctrl+W</h5>
            <p class="text-sm text-gray-700">Padrão universal para fechar aba atual desde os anos 90.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">Ctrl+L</h5>
            <p class="text-sm text-gray-700">Foco na barra de endereço, mantido por mais de 30 anos.</p>
          </div>
        </div>
      `
    },
      ...
      content: `
        ...
        <div class="space-y-4">
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">As teclas usadas geralmente fazem associação com a função:</p>
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">Combinações são projetadas para serem alcançadas com facilidade:</p>
            <ul class="list-disc list-inside text-gray-700 text-sm mt-2 space-y-1">
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">Mantém padrões semelhantes em diferentes softwares:</p>
            <ul class="list-disc list-inside text-gray-700 text-sm mt-2 space-y-1">
