    ...
    const contentSections = [
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-400">Não compre processadores com menos de 6 núcleos em 2026.</p>
      ...
      `
        ...
        <div class="bg-yellow-900/10 p-4 rounded-lg border border-yellow-500/20 mt-6">
          ...
          <p class="text-sm text-gray-400">Em orçamentos apertados, é melhor investir em uma SSD menor de qualidade superior do que em um SSD maior de baixa velocidade. A velocidade do armazenamento afeta o tempo de carregamento de jogos e a responsividade geral do sistema.</p>
        </div>
      `
        },
        {
        ...
        <div class="bg-blue-900/10 p-4 rounded-lg border border-blue-500/20 mt-6">
          ...
          <p class="text-sm text-gray-400">Certifique-se de que a placa mãe é compatível com a CPU e tem slots suficientes para a RAM planejada. Verifique também se tem saídas de vídeo (HDMI/DP) caso precise usar o PC sem placa de vídeo dedicada.</p>
        </div>
      `
        },
        {
        ...
        <div class="bg-red-900/10 p-4 rounded-lg border border-red-500/20 mt-6">
          ...
          <p class="text-sm text-gray-400">Fontes ruins podem danificar permanentemente seus componentes e até causar incêndios. Sempre compre fontes com certificação 80+ Bronze no mínimo e de marcas confiáveis.</p>
        </div>
      `
        },
        {
      ...
      `
        ...
        <div class="bg-yellow-900/10 p-4 rounded-lg border border-yellow-500/20 mt-6">
          ...
          <p class="text-sm text-gray-400">Mesmo com um PC de custo-benefício, as otimizações corretas podem proporcionar uma experiência de jogo excelente. Um PC bem configurado com RX 6600 pode superar um PC mais caro mal configurado.</p>
        </div>
      `
        }
    ];
    ...
    const advancedContentSections = [
      {
        ...
        content: `
          <p class="mb-4 text-gray-400 leading-relaxed">O mercado de hardware para PCs gamers está passando por transformações significativas, e estar ciente dessas mudanças ajuda a tomar decisões mais inteligentes para futuras atualizações.</p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            <div class="bg-gradient-to-br from-teal-900/30 to-emerald-900/20 p-5 rounded-xl border border-teal-500/40">
              ...
              <p class="text-sm text-gray-400 mb-3">Novas tecnologias estão surgindo para otimizar automaticamente o desempenho de hardware:</p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
            ...
            <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
              ...
              <p class="text-sm text-gray-400">Mantenha-se informado sobre novas tecnologias e como elas afetam a montagem de PCs gamers.</p>
            </div>
          </div>
        `,
      },
      {
        ...
        content: `
          <p class="mb-4 text-gray-400 leading-relaxed">Mesmo com um PC montado com foco em custo-benefício, existem otimizações avançadas que podem extrair o máximo de desempenho do hardware disponível.</p>
          ...
          <div class="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-6 rounded-xl border border-purple-500/30 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-black/30 p-4 rounded-lg">
                ...
                <p class="text-gray-400 text-sm">Configurações que podem ser ajustadas para melhorar o desempenho:</p>
              ...
              <div class="bg-black/30 p-4 rounded-lg">
                ...
                <p class="text-gray-400 text-sm">Otimizações específicas para memórias:</p>
                <ul class="mt-2 text-xs text-gray-400 space-y-1">
          ...
          <p class="mb-4 text-gray-400 leading-relaxed">O overclocking pode fornecer ganhos significativos de desempenho, mesmo em componentes de custo-benefício:</p>
          
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
            <div class="bg-[#171313] p-4 rounded-xl border border-[#31A8FF]/30">
              <h4 class="font-bold text-[#31A8FF] mb-2">CPU Overclocking</h4>
              <p class="text-sm text-gray-400">Aumente o multiplicador base com acompanhamento de tensão adequada.</p>
            </div>
            <div class="bg-[#171313] p-4 rounded-xl border border-[#FF4B6B]/30">
              <h4 class="font-bold text-[#FF4B6B] mb-2">GPU Boost</h4>
              <p class="text-sm text-gray-400">Ajuste Power Limit e Temperature Limit para extrair mais desempenho.</p>
            </div>
            <div class="bg-[#171313] p-4 rounded-xl border border-[#8B31FF]/30">
              <h4 class="font-bold text-[#8B31FF] mb-2">RAM Timings</h4>
              <p class="text-sm text-gray-400">Ajuste manualmente os timings para melhor estabilidade e performance.</p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: `
          <p class="mb-4 text-gray-400 leading-relaxed">Entender as diferenças entre componentes similares ajuda a tomar decisões mais informadas ao montar um PC com foco em custo-benefício.</p>
          ...
          <p class="mb-4 text-gray-400 leading-relaxed">Ao montar um PC com foco em custo-benefício, é importante equilibrar os componentes para evitar gargalos. Um processador potente com uma GPU fraca (ou vice-versa) não aproveitará ao máximo o hardware disponível.</p>
          
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
            <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
              <h4 class="font-bold text-white mb-2">Equilíbrio de Componentes</h4>
              <p class="text-sm text-gray-400">Combine componentes de forma que nenhum seja excessivamente mais potente que os outros, evitando desperdício de recursos.</p>
            </div>
            <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
              <h4 class="font-bold text-white mb-2">Futuro e Upgrade</h4>
              <p class="text-sm text-gray-400">Escolha componentes que permitam upgrades futuros dentro do mesmo ecossistema (socket, chipset, etc.).</p>
            </div>
          </div>
        `,
      }
