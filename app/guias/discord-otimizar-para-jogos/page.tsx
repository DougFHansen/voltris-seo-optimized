    ...
    const contentSections = [
        ...
        <div class="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-6 rounded-xl border border-blue-500/30 mt-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-700">O Discord pode usar entre 2-15% da GPU dependendo das configurações, especialmente com aceleração de hardware ativada.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h4 class="font-bold text-purple-400 mb-2">Uso de CPU</h4>
              <p class="text-gray-700">Funções como Krisp e codificação de áudio podem usar 5-20% da CPU em sistemas mais fracos.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h4 class="font-bold text-green-400 mb-2">Uso de RAM</h4>
              <p class="text-gray-700">O Discord pode consumir entre 100-500MB de RAM, aumentando com o tempo de uso.</p>
            </div>
          </div>
        </div>
      `
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700">Este é o ponto que mais afeta o FPS:</p>
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div class="bg-[#1E1E22] p-4 rounded-lg border border-orange-500/30">
              ...
              <p class="text-gray-700 text-sm">Cliente de voz leve com excelente qualidade e baixo uso de recursos.</p>
            </div>
            <div class="bg-[#1E1E22] p-4 rounded-lg border border-purple-500/30">
              <h5 class="font-bold text-purple-400 mb-2">TeamSpeak</h5>
              <p class="text-gray-700 text-sm">Solução profissional com baixo impacto no sistema.</p>
            </div>
            <div class="bg-[#1E1E22] p-4 rounded-lg border border-green-500/30">
              <h5 class="font-bold text-green-400 mb-2">Ventrilo</h5>
              <p class="text-gray-700 text-sm">Opção tradicional com configurações avançadas de uso de recursos.</p>
            </div>
          </div>
      ...
      content: `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20">
            ...
            <p class="text-gray-700 text-sm mb-3">Responsável pela criação e gerenciamento das janelas:</p>
          ...
          <div class="bg-purple-900/10 p-5 rounded-xl border border-purple-500/20">
            ...
            <p class="text-gray-700 text-sm mb-3">Executa a interface do usuário:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
      ...
      content: `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          <div class="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 p-5 rounded-xl border border-cyan-500/30">
            ...
            <p class="text-gray-700 text-sm mb-3">Ajustes para priorizar jogos sobre o Discord:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
          ...
          <div class="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 p-5 rounded-xl border border-emerald-500/30">
            ...
            <p class="text-gray-700 text-sm mb-3">Otimizações para reduzir latência de voz:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
      ...
      content: `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          <div class="bg-rose-900/10 p-5 rounded-xl border border-rose-500/20">
            ...
            <p class="text-gray-700 text-sm mb-3">Questões frequentes durante streams:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
          ...
          <div class="bg-amber-900/10 p-5 rounded-xl border border-amber-500/20">
            ...
            <p class="text-gray-700 text-sm mb-3">Abordagens para mitigar problemas:</p>
            <ul class="list-disc list-inside text-gray-700 space-y-1 text-sm">
      ...
      content: `
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-sm text-gray-700">Baseado em Erlang para alta concorrência e tolerância a falhas.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">2018-2020</h5>
            <p class="text-sm text-gray-700">Migração parcial para Rust e otimizações de rede.</p>
          </div>
          
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h5 class="font-bold text-green-400 mb-2">2021-Presente</h5>
            <p class="text-sm text-gray-700">Microserviços e otimizações para WebRTC e comunicação em tempo real.</p>
          </div>
        </div>
      `
    },
      ...
      content: `
        ...
        <div class="space-y-4">
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">Todas as comunicações entre o cliente e os servidores do Discord são criptografadas usando TLS 1.2 ou superior:</p>
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">Para comunicações de voz e vídeo, o Discord utiliza WebRTC com criptografia SRTP:</p>
            <ul class="list-disc list-inside text-gray-700 text-sm mt-2 space-y-1">
          ...
          <div class="bg-red-900/10 p-5 rounded-xl border border-red-500/30">
            ...
            <p class="text-gray-700 text-sm">Dados armazenados são protegidos com criptografia em repouso:</p>
            <ul class="list-disc list-inside text-gray-700 text-sm mt-2 space-y-1">
