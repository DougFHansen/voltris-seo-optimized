    ...
    const contentSections = [
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700">O BlueStacks é o mais completo, mas também o mais pesado.</p>
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700 border-l-4 border-yellow-500 pl-4 bg-yellow-900/10 p-4 rounded">
