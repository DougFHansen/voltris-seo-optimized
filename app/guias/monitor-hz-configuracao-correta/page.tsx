...
export default function MonitorGuide() {
    ...
    const contentSections = [
      ...
      `
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-emerald-900/40 p-3 rounded border border-emerald-500">
                ...
                <p class="text-gray-700 text-xs"><strong>Ponto Doce.</strong> Nitidez boa sem artefatos.</p>
            </div>
            <div class="bg-red-900/40 p-3 rounded border border-red-500">
                <h5 class="text-red-400 font-bold text-sm">Overdrive: Extreme</h5>
                <p class="text-gray-700 text-xs text-red-300"><strong>PERIGO.</strong> Causa "Inverse Ghosting" (Corona). Um rastro branco brilhante aparece atrás dos objetos. Piora a precisão em FPS.</p>
            </div>
        </div>
      ...
      `
        ...
        <p class="mt-2 text-gray-700 text-sm bg-blue-900/20 p-3 rounded">
