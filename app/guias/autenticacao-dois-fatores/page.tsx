...
export default function TwoFactorGuide() {
  ...
  const contentSections = [
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Esqueça o Google Authenticator antigo (ele não tinha backup na nuvem por anos, embora agora tenha, muitos migraram). Aqui estão as melhores opções modernas:</p>
      ...
      content: `
        <div class="space-y-4">
            ...
            <div class="bg-[#0A0A0F] p-4 rounded-xl border border-white/5">
                ...
                <p class="text-xs text-gray-700 mb-2">A Steam usa seu próprio app, não aceita Authy/Google Auth nativamente.</p>
                <ol class="list-decimal list-inside text-sm text-gray-700">
