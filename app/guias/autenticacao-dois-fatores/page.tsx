...
export default function TwoFactorGuide() {
  ...
  const contentSections = [
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400">Esqueça o Google Authenticator antigo (ele não tinha backup na nuvem por anos, embora agora tenha, muitos migraram). Aqui estão as melhores opções modernas:</p>
  ...
  const advancedContentSections = [
    ...
    },
    {
      ...
      content: `
        ...
        <ol class="list-decimal list-inside text-gray-400 space-y-3 bg-[#0A0A0F] p-5 rounded-xl border border-gray-700">
