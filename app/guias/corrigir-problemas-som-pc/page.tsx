...
export default function CorrigirProblemasSomPCGuide() {
    ...
    const externalReferences = [
        { name: "Suporte Microsoft Áudio", url: "https://support.microsoft.com/pt-br/windows/corrigir-problemas-de-som-ou-%C3%A1udio-no-windows-73025246-b61c-40fb-671a-2535c7cd56c8" },
        { name: "Drivers Realtek", url: "https://www.realtek.com/pt-br/downloads/" },
        { name: "Documentação Áudio Windows", url: "https://learn.microsoft.com/pt-br/windows/win32/coreaudio/" }
    ];
