    ...
    const contentSections = [
      ...
      `
        ...
        <div class="bg-green-900/10 border-l-4 border-green-500 p-5 rounded-r-lg">
            ...
            <p class="text-gray-700 text-sm">Se você tem XMP/EXPO ativado na BIOS e a RAM falha nos testes, tente <strong>desativar o XMP</strong> e testar na frequência base (2133/3200 MHz). RAM instável no XMP não significa RAM com defeito — pode ser que o IMC do processador não suporte aquela frequência específica.</p>
        </div>
      `
        },
        {
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
            <div class="bg-[#0A0A0F] border border-green-500/30 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-xs">O disco está saudável. Continue usando normalmente mas mantenha backups regulares.</p>
            </div>
            <div class="bg-[#0A0A0F] border border-yellow-500/30 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-xs">Faça backup AGORA. O disco está se deteriorando. Compre um substituto e migre os dados.</p>
            </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    <tr class="border-t border-white/5">
                        ...
                        <td class="p-3 text-gray-700">Reallocated Sectors (setores ruins substituídos)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">C5</td>
                        <td class="p-3 text-gray-700">Current Pending Sectors (setores esperando realocação)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">C6</td>
                        <td class="p-3 text-gray-700">Uncorrectable Sectors (setores irrecuperáveis)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">E9</td>
                        <td class="p-3 text-gray-700">NAND Endurance (vida útil do SSD)</td>
      ...
      `
        ...
        <div class="space-y-4 mb-6">
            ...
            <div class="bg-[#0A0A0F] border border-[#8B31FF]/20 p-5 rounded-xl">
                ...
                <p class="text-gray-700 text-sm mb-2">Selecione "GPU: 3D" ou use o FurMark separadamente. Duração: 15-20 minutos.</p>
                <p class="text-gray-700 text-xs"><strong>Sinal de problema:</strong> Artefatos visuais (pixels coloridos aleatórios), driver crashando ("Display driver stopped responding"), ou PC desligando.</p>
            </div>
            <div class="bg-[#0A0A0F] border border-[#FF4B6B]/20 p-5 rounded-xl">
                ...
                <p class="text-gray-700 text-sm mb-2">Selecione "Power Supply" no OCCT. Esse estressará CPU e GPU simultaneamente. Duração: 15-30 min.</p>
                <p class="text-gray-700 text-xs"><strong>Sinal de problema:</strong> PC desliga (a fonte não aguenta a carga pico), reinicia, ou o OCCT detecta queda de voltagem nos rail 12V/5V.</p>
            </div>
        </div>
        <div class="bg-yellow-900/10 border-l-4 border-yellow-500 p-5 rounded-r-lg">
            <p class="text-gray-700 text-sm"><strong class="text-yellow-400">Dica Importante:</strong> Se o PC desligar sob o teste de Power Supply mas aguentar CPU e GPU separadamente, o problema é quase certamente a fonte de alimentação sendo insuficiente para a configuração. Verifique se a fonte tem wattagem adequada com o <a href="https://www.bequiet.com/en/psucalculator" target="_blank" rel="noopener noreferrer" class="text-[#31A8FF] hover:underline">calculador da be quiet!</a>.</p>
        </div>
      `
        },
        {
        ...
        <div class="space-y-3 mb-6">
            <div class="bg-[#0A0A0F] border border-white/5 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-sm">Quase sempre RAM com problema. Teste com TestMem5 e MemTest86+.</p>
            </div>
            <div class="bg-[#0A0A0F] border border-white/5 p-4 rounded-xl">
                <code class="text-red-400 font-mono block mb-2">PAGE_FAULT_IN_NONPAGED_AREA (0x00000050)</code>
                <p class="text-gray-700 text-sm">RAM ruim ou driver corrompido. Teste a RAM e reinstale drivers de vídeo com DDU.</p>
            </div>
            <div class="bg-[#0A0A0F] border border-white/5 p-4 rounded-xl">
                <code class="text-red-400 font-mono block mb-2">DPC_WATCHDOG_VIOLATION (0x00000133)</code>
                <p class="text-gray-700 text-sm">Driver ou firmware desatualizado. Atualize drivers e firmware do SSD.</p>
            </div>
            <div class="bg-[#0A0A0F] border border-white/5 p-4 rounded-xl">
                <code class="text-red-400 font-mono block mb-2">DRIVER_IRQL_NOT_LESS_OR_EQUAL</code>
                <p class="text-gray-700 text-sm">Driver problemático. Use o DDU para remover e reinstalar o driver de vídeo ou outro driver recentemente instalado.</p>
            </div>
        </div>
        <p class="text-gray-700 text-sm">Para um diagnóstico aprofundado de BSODs, acesse nosso <a href="/guias/como-analisar-tela-azul-bsod-dmp-guia" class="text-[#31A8FF] hover:underline">Guia de Análise de Dump de BSOD</a> onde ensinamos a abrir arquivos .dmp e identificar exatamente qual arquivo de driver causou a tela azul.</p>
      `
        }
    ];
