...
export default function HardwareDiagnosticGuide() {
    ...
    const contentSections = [
      ...
      `
        ...
        <p class="mb-3 text-gray-400 text-sm">O melhor teste de RAM que roda dentro do próprio Windows.</p>
        ...
        <p class="mb-3 text-gray-400 text-sm">Mais completo, pois roda fora do Windows e testa a RAM pura.</p>
        <ol class="list-decimal list-inside text-gray-400 space-y-2 ml-4 mb-6">
        ...
        <div class="bg-green-900/10 border-l-4 border-green-500 p-5 rounded-r-lg">
            ...
            <p class="text-gray-400 text-sm">Se você tem XMP/EXPO ativado na BIOS e a RAM falha nos testes, tente <strong>desativar o XMP</strong> e testar na frequência base (2133/3200 MHz). RAM instável no XMP não significa RAM com defeito — pode ser que o IMC do processador não suporte aquela frequência específica.</p>
        </div>
      `
        },
        {
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    <tr class="border-t border-white/5">
                        ...
                        <td class="p-3 text-gray-400">Reallocated Sectors (setores ruins substituídos)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">C5</td>
                        <td class="p-3 text-gray-400">Current Pending Sectors (setores esperando realocação)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">C6</td>
                        <td class="p-3 text-gray-400">Uncorrectable Sectors (setores irrecuperáveis)</td>
                        <td class="p-3 text-red-400">Qualquer valor > 0</td>
                    </tr>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-white font-mono">E9</td>
                        <td class="p-3 text-gray-400">NAND Endurance (vida útil do SSD)</td>
      ...
      `
        ...
        <ol class="list-decimal list-inside text-gray-400 space-y-2 ml-4 mb-5">
        ...
        <div class="space-y-4 mb-6">
            <div class="bg-[#0A0A0F] border border-[#31A8FF]/20 p-5 rounded-xl">
                ...
                <p class="text-gray-400 text-sm mb-2">Selecione "CPU: Linpack" no OCCT. Duração: 15-30 minutos.</p>
            ...
            <div class="bg-[#0A0A0F] border border-[#8B31FF]/20 p-5 rounded-xl">
                ...
                <p class="text-gray-400 text-sm mb-2">Selecione "GPU: 3D" ou use o FurMark separadamente. Duração: 15-20 minutos.</p>
            ...
            <div class="bg-[#0A0A0F] border border-[#FF4B6B]/20 p-5 rounded-xl">
                ...
                <p class="text-gray-400 text-sm mb-2">Selecione "Power Supply" no OCCT. Esse estressará CPU e GPU simultaneamente. Duração: 15-30 min.</p>
        ...
        <div class="bg-yellow-900/10 border-l-4 border-yellow-500 p-5 rounded-r-lg">
            <p class="text-gray-400 text-sm"><strong class="text-yellow-400">Dica Importante:</strong> Se o PC desligar sob o teste de Power Supply mas aguentar CPU e GPU separadamente, o problema é quase certamente a fonte de alimentação sendo insuficiente para a configuração. Verifique se a fonte tem wattagem adequada com o <a href="https://www.bequiet.com/en/psucalculator" target="_blank" rel="noopener noreferrer" class="text-[#31A8FF] hover:underline">calculador da be quiet!</a>.</p>
        </div>
      `
        },
        {
