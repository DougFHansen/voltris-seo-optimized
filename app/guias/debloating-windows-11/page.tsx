    ...
    const contentSections = [
        ...
        <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20 my-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                <a href="https://github.com/DougFHansen/Download-Voltris-Optimizer/releases/download/v1.0.1.5/VoltrisOptimizerInstallerX86.exe" className="px-8 py-3 bg-white/5 text-white border border-white/10 font-bold rounded-xl hover:bg-white/10 transition-all flex items-center justify-center text-xs">
                    Versão x86
                </a>
            </div>
        </div>
