  ...
  const contentSections = [
    {
      ...
      content: `
        ...
        <div class="bg-red-900/20 p-4 rounded-lg border-l-4 border-red-500 my-6">
          ...
          <p class="text-gray-400 mt-2">Segundo o relatório anual da Symantec, os ataques cibernéticos aumentaram 38% em 2026, com mais de 4.8 bilhões de tentativas de ataques registradas globalmente. Cerca de 1 em cada 99 emails é um phishing, e a taxa de sucesso desses ataques triplicou em relação a 2020.</p>
        </div>
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400">Antigamente, e-mails de phishing tinham erros de português óbvios. Em 2026:</p>
        ...
        <div class="bg-yellow-900/20 p-4 rounded-lg border-l-4 border-yellow-500 my-6">
          ...
          <p class="text-gray-400 mt-2">Com o avanço da inteligência artificial, os ataques de phishing agora utilizam técnicas de personalização avançada, conhecidas como spear phishing, onde os criminosos usam dados públicos de redes sociais para criar mensagens altamente convincentes e direcionadas.</p>
        </div>
        ...
        <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20 mb-6">
          ...
          <table class="min-w-full bg-gray-800/50 rounded-lg overflow-hidden">
            <thead class="bg-gray-700">
              <tr>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Método</th>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Descrição</th>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Efetividade</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-700">
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Verificação de URL</td>
                <td class="py-2 px-4 text-sm text-gray-400">Passar o mouse sobre links para revelar URL real</td>
                <td class="py-2 px-4 text-sm text-green-400">Alta</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">2FA</td>
                <td class="py-2 px-4 text-sm text-gray-400">Autenticação em duas etapas para todas as contas</td>
                <td class="py-2 px-4 text-sm text-green-400">Muito Alta</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Email Secundário</td>
                <td class="py-2 px-4 text-sm text-gray-400">Usar email diferente para contas sensíveis</td>
                <td class="py-2 px-4 text-sm text-yellow-400">Média</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Antiphishing</td>
                <td class="py-2 px-4 text-sm text-gray-400">Extensões e filtros de email antiphishing</td>
                <td class="py-2 px-4 text-sm text-green-400">Alta</td>
              </tr>
            </tbody>
          </table>
      ...
      content: `
        ...
        <div class="space-y-6">
          <div class="border-l-4 border-green-500 pl-4 py-1">
            ...
            <p class="text-gray-400 text-sm mb-2">Adicione uma camada extra de segurança exigindo um código PIN ao vincular seu número a outro dispositivo.</p>
          ...
          <div class="border-l-4 border-purple-500 pl-4 py-1">
            ...
            <p class="text-gray-400 text-sm mb-2">Controle quem pode ver sua foto de perfil, status e último visto.</p>
            <ol class="list-decimal list-inside text-gray-400 space-y-1 text-sm">
          ...
          <div class="border-l-4 border-indigo-500 pl-4 py-1">
            ...
            <p class="text-gray-400 text-sm mb-2">Verifique se seus chats estão criptografados com contatos desconhecidos.</p>
            <ol class="list-decimal list-inside text-gray-400 space-y-1 text-sm">
    ...
    },
    {
      ...
      content: `
        ...
        <div class="bg-red-900/20 p-4 rounded-lg border-l-4 border-red-500 my-6">
          ...
          <p class="text-gray-400 mt-2">Em redes Wi-Fi públicas, você está vulnerável a ataques como Man-in-the-Middle (MitM), onde um invasor intercepta a comunicação entre seu dispositivo e a internet. Isso permite roubar senhas, dados bancários e outras informações sensíveis.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm">Criptografa todo o tráfego de internet, protegendo seus dados</p>
          </div>
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h4 class="font-bold text-blue-400 mb-2">HTTPS Only</h4>
            <p class="text-gray-400 text-sm">Certifique-se de que os sites usam conexão segura (cadeado verde)</p>
          </div>
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            <h4 class="font-bold text-blue-400 mb-2">Desativar Compartilhamento</h4>
            <p class="text-gray-400 text-sm">Desative compartilhamento de arquivos e impressoras em redes públicas</p>
          </div>
        </div>
        <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20 mb-6">
          <h4 class="text-white font-bold mb-3 flex items-center">
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Ligações fraudulentas que simulam instituições confiáveis para obter informações pessoais.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Emails direcionados que usam informações pessoais para parecerem legítimos.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Criação de uma história (pretexto) para ganhar confiança e obter informações.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
        ...
        <div class="bg-green-900/20 p-4 rounded-lg border-l-4 border-green-500 my-6">
          ...
          <p class="text-gray-400 mt-2">A melhor defesa contra engenharia social é o treinamento e conscientização. Desconfie de solicitações urgentes, verifique a identidade de quem está contactando você e nunca forneça informações sensíveis por telefone ou email sem confirmação prévia.</p>
        </div>
      `
    },
    {
      ...
      content: `
        ...
        <div class="overflow-x-auto mb-6">
          <table class="min-w-full bg-gray-800/50 rounded-lg overflow-hidden">
            <thead class="bg-gray-700">
              <tr>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Elemento</th>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Características Suspeitas</th>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-400">Ferramentas de Detecção</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-700">
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Áudio</td>
                <td class="py-2 px-4 text-sm text-gray-400">Voz que não combina perfeitamente com os movimentos labiais</td>
                <td class="py-2 px-4 text-sm text-gray-400">Software especializado em análise de áudio</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Vídeo</td>
                <td class="py-2 px-4 text-sm text-gray-400">Blinking irregular, sombras inconsistentes, bordas artificiais</td>
                <td class="py-2 px-4 text-sm text-gray-400">Deepfake detection APIs</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Comportamento</td>
                <td class="py-2 px-4 text-sm text-gray-400">Fala ou gestos atípicos para a pessoa retratada</td>
                <td class="py-2 px-4 text-sm text-gray-400">Análise de padrões de comportamento</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-400 font-medium">Contexto</td>
                <td class="py-2 px-4 text-sm text-gray-400">Situações improváveis ou fora do contexto habitual</td>
                <td class="py-2 px-4 text-sm text-gray-400">Verificação cruzada com fontes oficiais</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
              ...
              <p class="text-gray-400 text-sm">Use canais oficiais para confirmar a identidade de alguém em situações duvidosas.</p>
            </div>
            <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
              <h5 class="font-bold text-white mb-2">Conscientização</h5>
              <p class="text-gray-400 text-sm">Eduque-se e eduque outros sobre os riscos e sinais de deepfakes.</p>
            </div>
          </div>
        </div>
      `
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Controle quem pode ver suas informações pessoais e interagir com você.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Ative autenticação em duas etapas e verificação de login.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Minimize dados visíveis para estranhos e motores de busca.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
        ...
        <div class="bg-yellow-900/20 p-4 rounded-lg border-l-4 border-yellow-500 my-6">
          ...
          <p class="text-gray-400 mt-2">Configure notificações para quando alguém tentar acessar sua conta, reveja regularmente suas conexões e amigos, e leia periodicamente os termos de uso e políticas de privacidade das plataformas que você utiliza.</p>
        </div>
      `
    },
    {
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Mantenha 3 cópias dos dados, em 2 tipos de mídia diferentes, com 1 cópia offsite.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Backups que não podem ser alterados ou excluídos por atacantes.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Verifique periodicamente se seus backups podem ser restaurados.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Sinais que sua conta pode ter sido comprometida.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-400 text-sm mb-2">Sinais que seu dispositivo pode ter sido comprometido.</p>
            <ul class="text-sm text-gray-400 ml-5 space-y-1 list-disc">
        ...
        <div class="bg-yellow-900/20 p-4 rounded-lg border-l-4 border-yellow-500 my-6">
          ...
          <p class="text-gray-400 mt-2">Se você notar atividades suspeitas, altere suas senhas imediatamente, verifique se o 2FA ainda está ativo e rode varreduras de segurança no seu dispositivo. Em casos graves, entre em contato com o suporte da plataforma afetada.</p>
        </div>
      `
    }
  ];
  ...
  const faqItems = [
    {
      ...
      answer: `
        <p class="text-gray-400 mb-2">A segurança digital é o conjunto de práticas e ferramentas utilizadas para proteger dados, dispositivos e identidades online. Em 2026, é particularmente importante devido ao aumento de ameaças cibernéticas sofisticadas, como deepfakes, phishing alimentado por IA e ataques direcionados que utilizam informações públicas coletadas de redes sociais.</p>
        <p class="text-gray-400">A proteção digital agora envolve não apenas antivírus, mas também comportamentos conscientes, autenticação em múltiplas etapas e proteção da privacidade pessoal.</p>
      `
    },
    {
      question: "Como posso identificar um email de phishing?",
      answer: `
        <p class="text-gray-400 mb-2">Emails de phishing frequentemente contêm:</p>
        <ul class="list-disc list-inside text-gray-400 space-y-1 mb-2">
          <li>Urgência injustificada ("atualize seus dados agora!")</li>
          <li>Erros ortográficos ou de formatação</li>
          <li>Links com URLs truncadas ou mascaradas</li>
          <li>Endereço de email do remetente suspeito ou semelhante ao oficial</li>
        </ul>
        <p class="text-gray-400">Para verificar, passe o mouse sobre os links sem clicar para ver a URL real, e sempre acesse sites importantes digitando o endereço diretamente no navegador.</p>
      `
    },
    {
      question: "O que é engenharia social e como me proteger dela?",
      answer: `
        <p class="text-gray-400 mb-2">Engenharia social é a manipulação psicológica de pessoas para obter informações confidenciais. Golpistas usam técnicas como vishing (ligações fraudulentas), spear phishing (emails direcionados) e pretexting (histórias inventadas) para explorar emoções como medo e urgência.</p>
        <p class="text-gray-400">Para se proteger, desconfie de solicitações urgentes de informação, verifique a identidade de quem está contactando você e nunca forneça dados sensíveis sem confirmação prévia por meio de canais oficiais.</p>
      `
    },
    {
      question: "Como funciona a confirmação em duas etapas no WhatsApp?",
      answer: `
        <p class="text-gray-400 mb-2">A confirmação em duas etapas do WhatsApp adiciona uma camada extra de segurança exigindo um código PIN ao vincular seu número a outro dispositivo. Para ativar, vá em Configurações > Conta > Confirmação em duas etapas e crie um PIN de 6 dígitos.</p>
        <p class="text-gray-400">Você também pode adicionar um e-mail de recuperação opcional para ajudar na recuperação da conta caso esqueça seu PIN.</p>
      `
    },
    {
      question: "Quais são os riscos de usar redes Wi-Fi públicas?",
      answer: `
        <p class="text-gray-400 mb-2">Redes Wi-Fi públicas são vulneráveis a ataques como Man-in-the-Middle (MitM), onde um invasor intercepta a comunicação entre seu dispositivo e a internet. Isso permite roubar senhas, dados bancários e outras informações sensíveis.</p>
        <p class="text-gray-400">Para se proteger, evite acessar contas sensíveis, use uma VPN para criptografar seu tráfego e certifique-se de que os sites usam conexão segura (HTTPS).</p>
      `
    },
    {
      question: "O que são deepfakes e como detectá-los?",
      answer: `
        <p class="text-gray-400 mb-2">Deepfakes são vídeos, áudios ou imagens sintéticas criadas com inteligência artificial para simular pessoas reais. Em 2026, são usados em golpes e campanhas de desinformação.</p>
        <p class="text-gray-400">Para detectar, observe blinkings irregulares, sombras inconsistentes, bordas artificiais, voz não combinando com movimentos labiais e comportamentos atípicos para a pessoa retratada. Sempre verifique informações com fontes oficiais.</p>
      `
    },
    {
      question: "Como proteger minhas redes sociais contra invasores?",
      answer: `
        <p class="text-gray-400 mb-2">Para proteger suas redes sociais:</p>
        <ul class="list-disc list-inside text-gray-400 space-y-1 mb-2">
        ...
        <p class="text-gray-400">Além disso, evite compartilhar datas de nascimento completas e fotos com geolocalização sensível.</p>
      `
    },
    {
      question: "Qual a importância de ter backups regulares?",
      answer: `
        <p class="text-gray-400 mb-2">Backups regulares são essenciais para proteger seus dados contra ransomware, falhas de hardware, erros humanos e desastres naturais. Seguindo a regra 3-2-1 (3 cópias, 2 tipos de mídia diferentes, 1 cópia offsite), você garante que seus dados estejam seguros e recuperáveis.</p>
        <p class="text-gray-400">É crucial testar regularmente seus backups para garantir que possam ser restaurados quando necessário.</p>
      `
    },
    {
      question: "O que são Indicadores de Comprometimento (IoCs)?",
      answer: `
        <p class="text-gray-400 mb-2">Indicadores de Comprometimento (IoCs) são evidências observáveis de atividades maliciosas em sistemas ou redes. Exemplos incluem logins de localizações geográficas improváveis, tentativas repetidas de acesso com falha, mudanças não autorizadas nas configurações da conta e atividades que você não reconhece.</p>
        <p class="text-gray-400">Monitorar esses indicadores ajuda a detectar e responder a incidentes de segurança rapidamente, minimizando danos.</p>
      `
    },
    {
      question: "Como posso monitorar minhas contas por atividades suspeitas?",
      answer: `
        <p class="text-gray-400 mb-2">Você pode monitorar suas contas ativando alertas de segurança que notificam sobre logins em novos dispositivos, alterações de senha ou dados pessoais e atividades incomuns. Revise regularmente as sessões ativas e dispositivos conectados nas configurações de segurança de cada plataforma.</p>
        <p class="text-gray-400">Também é útil verificar extratos bancários e atividades de contas periodicamente para detectar movimentações não autorizadas.</p>
      `
    },
    {
      question: "O que devo fazer se suspeitar que minha conta foi invadida?",
      answer: `
        <p class="text-gray-400 mb-2">Se suspeitar que sua conta foi invadida, altere sua senha imediatamente, verifique se o 2FA ainda está ativo e revise as configurações da conta por alterações não autorizadas. Execute uma varredura de segurança no seu dispositivo e revise as sessões ativas.</p>
        <p class="text-gray-400">Entre em contato com o suporte da plataforma afetada e, se necessário, notifique instituições financeiras caso dados sensíveis tenham sido comprometidos.</p>
      `
    },
    {
      question: "Como posso me proteger contra golpes de vishing (ligações fraudulentas)?",
      answer: `
        <p class="text-gray-400 mb-2">Para se proteger contra vishing:</p>
        <ul class="list-disc list-inside text-gray-400 space-y-1 mb-2">
        ...
        <p class="text-gray-400">Lembre-se que instituições legítimas raramente pedem dados sensíveis por telefone.</p>
      `
    }
  ];
