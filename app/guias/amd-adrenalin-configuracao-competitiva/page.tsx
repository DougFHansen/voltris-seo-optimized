      ...
      `
        ...
        <ul class="list-disc list-inside text-gray-700 space-y-3 ml-4">
            ...
            <li><strong>Tessellation Mode:</strong> <span class="text-yellow-400 font-bold">Override application settings</span>.
                <br/><span class="text-sm text-gray-700 ml-6">Configure o <strong>Maximum Tessellation Level</strong> para <strong>8x ou 16x</strong>. Por padrão é 64x. A diferença visual é imperceptível, mas em jogos como The Witcher 3 ou Crysis, baixar de 64x para 8x dobra o FPS.</span>
            </li>
        </ul>
      `
        }
