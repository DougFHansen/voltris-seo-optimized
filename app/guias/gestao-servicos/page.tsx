    ...
    const contentSections = [
      ...
      `
        },
        {
            ...
            content: `
        <ol class="list-decimal list-inside text-gray-700 space-y-4 ml-4 mb-6">
        ...
        <div class="space-y-3 mb-6">
            <div class="flex items-start gap-4 bg-[#0A0A0F] border border-red-500/20 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-sm">O serviço inicia JUNTO com o Windows, sempre. É o mais pesado. Serviços críticos do sistema ficam aqui, mas muitos inúteis também.</p>
            </div>
            <div class="flex items-start gap-4 bg-[#0A0A0F] border border-yellow-500/20 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-sm">O serviço só inicia quando um programa explicitamente solicitar. Este é o status ideal para a maioria dos serviços que você não usa mas que algum app pode precisar eventualmente.</p>
            </div>
            <div class="flex items-start gap-4 bg-[#0A0A0F] border border-green-500/20 p-4 rounded-xl">
                ...
                <p class="text-gray-700 text-sm">O serviço nunca inicia, mesmo que um programa peça. Use com cuidado — libera mais memória, mas pode quebrar funcionalidades.</p>
            </div>
        </div>
        <div class="bg-yellow-900/10 border-l-4 border-yellow-500 p-6 rounded-r-lg">
            ...
            <p class="text-gray-700 text-sm">Antes de mexer em qualquer serviço, pressione Win, pesquise "Criar um ponto de restauração" e salve. Se algo der errado, você volta ao estado anterior em minutos.</p>
        </div>
      `
        },
        {
      ...
      `
        ...
        <div class="bg-red-900/10 border-l-4 border-red-500 p-6 rounded-r-lg mb-6">
            ...
            <p class="text-gray-700 text-sm">Desativar os serviços abaixo pode deixar o Windows <strong>inutilizável</strong>, sem reconhecer teclado, mouse, rede ou até sem conseguir iniciar.</p>
        </div>
        <div class="space-y-3">
      ...
      `
        },
        {
            ...
            content: `
        <p class="mb-4 text-gray-700">Desativou algo e alguma coisa parou de funcionar? Sem pânico. Você tem duas opções:</p>
        <div class="space-y-4">
