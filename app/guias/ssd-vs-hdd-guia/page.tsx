      ...
      `
        ...
        <div class="bg-[#0A0A0F] border border-white/5 rounded-xl overflow-hidden">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-gray-700">GTA V (Carregamento Inicial)</td>
                    ...
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-gray-700">Cyberpunk 2077 (Load Save)</td>
                    ...
                    <tr class="border-t border-white/5">
                        <td class="p-3 text-gray-700">Call of Duty Warzone (Match)</td>
