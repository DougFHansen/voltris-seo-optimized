...
export default function WindowsUpdateGuide() {
    ...
    const contentSections = [
      ...
      `
        ...
        <ol class="list-decimal list-inside text-gray-700 space-y-3 ml-4 bg-[#0A0A0F] p-4 rounded-xl border border-white/5 font-mono text-xs">
    ...
    const advancedContentSections = [
        {
            ...
            <div class="bg-gray-800/50 p-6 rounded-xl border border-gray-700 mb-8">
                ...
                <p class="text-gray-700 text-sm font-mono bg-black p-2 rounded">
