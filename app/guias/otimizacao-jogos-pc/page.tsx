...
export default function GuidePage() {
  const contentSections = [
        ...
        <div class="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-6 rounded-xl border border-blue-500/30 mt-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-700">Quantidade de quadros renderizados por segundo. Valores acima de 144 FPS são ideais para monitores de alta taxa de atualização.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h3 class="font-bold text-purple-400 mb-2">Input Lag</h3>
              <p class="text-gray-700">Tempo entre o comando do jogador e a resposta na tela. Deve ser inferior a 16ms para competição.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h3 class="font-bold text-green-400 mb-2">Frame Time</h3>
              <p class="text-gray-700">Tempo necessário para renderizar cada frame. Quanto mais estável, melhor a experiência de jogo.</p>
            </div>
          </div>
        </div>
      `,
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-700 leading-relaxed">Configurações profundas do sistema operacional para maximizar o desempenho de jogos.</p>`,
      subsections: [
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-yellow-900/30 p-4 rounded-lg border border-yellow-500/30 mt-4">
                ...
                <p class="text-gray-700 text-sm">Desativar serviços de segurança pode expor seu sistema a riscos. Faça isso apenas temporariamente e se você entender as implicações de segurança.</p>
              </div>
            </div>
          `
        },
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-700 leading-relaxed">A configuração padrão da NVIDIA foca em qualidade, não performance. Aqui estão as configurações otimizadas para jogos.</p>`,
      subsections: [
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-700 leading-relaxed">Configurações específicas para placas de vídeo AMD Radeon.</p>`,
      subsections: [
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-700 leading-relaxed">Otimizações mais avançadas que requerem ajustes de driver e BIOS.</p>`,
      subsections: [
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-blue-900/30 p-4 rounded-lg border border-blue-500/30 mt-4">
                ...
                <p class="text-gray-700 text-sm">Sempre limpe drivers antigos usando DDU (Display Driver Uninstaller) antes de instalar novos drivers para evitar conflitos.</p>
              </div>
            </div>
          `
        },
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-red-900/30 p-4 rounded-lg border border-red-500/30 mt-4">
                ...
                <p class="text-gray-700 text-sm">Alterações de BIOS podem tornar seu sistema instável. Anote as configurações antigas antes de alterar.</p>
              </div>
            </div>
          `
        }
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-700 leading-relaxed">Ferramentas e métodos para medir o impacto das otimizações.</p>`,
      subsections: [
            ...
            <div class="prose prose-invert max-w-none">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-green-500/30">
                  ...
                  <p class="text-gray-700 text-sm">Monitoramento em tempo real de GPU, FPS, temperatura e uso de CPU.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-blue-500/30">
                  <h5 class="font-bold text-blue-400 mb-2">HWiNFO64</h5>
                  <p class="text-gray-700 text-sm">Detalhes completos de hardware e sensores do sistema.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-purple-500/30">
                  <h5 class="font-bold text-purple-400 mb-2">FRAPS</h5>
                  <p class="text-gray-700 text-sm">Medição de FPS e captura de tela/vídeo.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-yellow-500/30">
                  <h5 class="font-bold text-yellow-400 mb-2">CapFrameX</h5>
                  <p class="text-gray-700 text-sm">Análise avançada de estabilidade de frames e input lag.</p>
                </div>
              </div>
            </div>
          `
  ...
  const advancedContentSections = [
      ...
      content: `
        ...
        <div class="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-6 rounded-xl border border-purple-500/30 mt-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-700 text-sm">Além das configurações básicas, existem parâmetros ocultos que podem ser ajustados para melhorar o desempenho:</p>
            ...
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-700 text-sm">Otimizações específicas para unidades de armazenamento:</p>
              <ul class="mt-2 text-xs text-gray-700 space-y-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
          <div class="bg-[#171313] p-4 rounded-xl border border-[#31A8FF]/30">
            ...
            <p class="text-sm text-gray-700">Aumente o multiplicador base (non-X CPUs) ou use o ratio (X-series) com acompanhamento de tensão adequada.</p>
          </div>
          <div class="bg-[#171313] p-4 rounded-xl border border-[#FF4B6B]/30">
            <h3 class="font-bold text-[#FF4B6B] mb-2">GPU Overclocking</h3>
            <p class="text-sm text-gray-700">Use ferramentas como MSI Afterburner ou EVGA Precision para pequenos incrementos no core clock e memory clock.</p>
          </div>
          <div class="bg-[#171313] p-4 rounded-xl border border-[#8B31FF]/30">
            <h3 class="font-bold text-[#8B31FF] mb-2">RAM Overclocking</h3>
            <p class="text-sm text-gray-700">Ative XMP/DOCP e ajuste manualmente os tempos (timings) para maior estabilidade e performance.</p>
          </div>
        </div>
      ...
      content: `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
          <div class="bg-[#1E1E22] p-4 rounded-lg border border-blue-500/30">
            ...
            <p class="text-sm text-gray-700">Desative o QoS para permitir que jogos utilizem toda a largura de banda disponível:</p>
          ...
          <div class="bg-[#1E1E22] p-4 rounded-lg border border-green-500/30">
            ...
            <p class="text-sm text-gray-700">Ajuste a prioridade de processos de rede para minimizar atrasos:</p>
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700 leading-relaxed">Diferentes gêneros de jogos têm requisitos e otimizações específicas. Entender essas diferenças permite ajustar o sistema para extrair o máximo de performance em cada tipo de jogo.</p>
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700 leading-relaxed">A indústria de jogos está constantemente evoluindo, e novas tecnologias estão surgindo para melhorar o desempenho e a experiência do jogador. Entender essas tendências ajuda a preparar seu sistema para o futuro e tirar proveito das próximas inovações.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div class="bg-gradient-to-br from-teal-900/30 to-emerald-900/20 p-5 rounded-xl border border-teal-500/40">
            ...
            <p class="text-sm text-gray-700 mb-3">Sistemas de IA estão sendo desenvolvidos para otimizar automaticamente configurações de jogo em tempo real:</p>
          ...
          <div class="bg-gradient-to-br from-amber-900/30 to-orange-900/20 p-5 rounded-xl border border-amber-500/40">
            ...
            <p class="text-sm text-gray-700 mb-3">Novas interfaces e APIs estão sendo desenvolvidas para reduzir latência e aumentar eficiência:</p>
            <ul class="space-y-2 text-xs text-gray-700">
