...
export default function GuidePage() {
  const contentSections = [
        ...
        <div class="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-6 rounded-xl border border-blue-500/30 mt-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-400">Quantidade de quadros renderizados por segundo. Valores acima de 144 FPS são ideais para monitores de alta taxa de atualização.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h3 class="font-bold text-purple-400 mb-2">Input Lag</h3>
              <p class="text-gray-400">Tempo entre o comando do jogador e a resposta na tela. Deve ser inferior a 16ms para competição.</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h3 class="font-bold text-green-400 mb-2">Frame Time</h3>
              <p class="text-gray-400">Tempo necessário para renderizar cada frame. Quanto mais estável, melhor a experiência de jogo.</p>
            </div>
          </div>
        </div>
      `,
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-400 leading-relaxed">Configurações profundas do sistema operacional para maximizar o desempenho de jogos.</p>`,
      subsections: [
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-yellow-900/30 p-4 rounded-lg border border-yellow-500/30 mt-4">
                ...
                <p class="text-gray-400 text-sm">Desativar serviços de segurança pode expor seu sistema a riscos. Faça isso apenas temporariamente e se você entender as implicações de segurança.</p>
              </div>
            </div>
          `
        },
        
        {
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <p class="text-gray-400">Desative o Core Parking para manter todos os núcleos disponíveis:</p>
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-400 leading-relaxed">A configuração padrão da NVIDIA foca em qualidade, não performance. Aqui estão as configurações otimizadas para jogos.</p>`,
      subsections: [
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-400 leading-relaxed">Configurações específicas para placas de vídeo AMD Radeon.</p>`,
      subsections: [
        
        {
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <p class="text-gray-400">No Radeon Software, vá para a aba "Jogos" e personalize as configurações para cada título:</p>
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-400 leading-relaxed">Otimizações mais avançadas que requerem ajustes de driver e BIOS.</p>`,
      subsections: [
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-blue-900/30 p-4 rounded-lg border border-blue-500/30 mt-4">
                ...
                <p class="text-gray-400 text-sm">Sempre limpe drivers antigos usando DDU (Display Driver Uninstaller) antes de instalar novos drivers para evitar conflitos.</p>
              </div>
            </div>
          `
        },
          ...
          content: `
            <div class="prose prose-invert max-w-none">
              ...
              <div class="bg-red-900/30 p-4 rounded-lg border border-red-500/30 mt-4">
                ...
                <p class="text-gray-400 text-sm">Alterações de BIOS podem tornar seu sistema instável. Anote as configurações antigas antes de alterar.</p>
              </div>
            </div>
          `
        }
    ...
    
    {
      ...
      content: `<p class="mb-4 text-gray-400 leading-relaxed">Ferramentas e métodos para medir o impacto das otimizações.</p>`,
      subsections: [
            ...
            <div class="prose prose-invert max-w-none">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-green-500/30">
                  ...
                  <p class="text-gray-400 text-sm">Monitoramento em tempo real de GPU, FPS, temperatura e uso de CPU.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-blue-500/30">
                  <h5 class="font-bold text-blue-400 mb-2">HWiNFO64</h5>
                  <p class="text-gray-400 text-sm">Detalhes completos de hardware e sensores do sistema.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-purple-500/30">
                  <h5 class="font-bold text-purple-400 mb-2">FRAPS</h5>
                  <p class="text-gray-400 text-sm">Medição de FPS e captura de tela/vídeo.</p>
                </div>
                <div class="bg-[#1E1E22] p-4 rounded-lg border border-yellow-500/30">
                  <h5 class="font-bold text-yellow-400 mb-2">CapFrameX</h5>
                  <p class="text-gray-400 text-sm">Análise avançada de estabilidade de frames e input lag.</p>
                </div>
              </div>
            </div>
          `
      ...
      content: `
        <div class="space-y-6">
          ...
          <div class="bg-[#1E1E22] p-5 rounded-lg border-l-4 border-[#8B31FF]">
            ...
            <div class="text-gray-400 text-sm pl-4 border-l border-gray-700">
  ...
  const advancedContentSections = [
    {
      ...
      content: `
        ...
        <div class="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-6 rounded-xl border border-purple-500/30 mt-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-400 text-sm">Além das configurações básicas, existem parâmetros ocultos que podem ser ajustados para melhorar o desempenho:</p>
            ...
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-400 text-sm">Otimizações específicas para unidades de armazenamento:</p>
              <ul class="mt-2 text-xs text-gray-400 space-y-1">
        ...
        <p class="mb-4 text-gray-400 leading-relaxed">O overclocking pode fornecer ganhos significativos de desempenho, mas deve ser feito com cuidado:</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
          <div class="bg-[#171313] p-4 rounded-xl border border-[#31A8FF]/30">
            ...
            <p class="text-sm text-gray-400">Aumente o multiplicador base (non-X CPUs) ou use o ratio (X-series) com acompanhamento de tensão adequada.</p>
          </div>
          <div class="bg-[#171313] p-4 rounded-xl border border-[#FF4B6B]/30">
            <h3 class="font-bold text-[#FF4B6B] mb-2">GPU Overclocking</h3>
            <p class="text-sm text-gray-400">Use ferramentas como MSI Afterburner ou EVGA Precision para pequenos incrementos no core clock e memory clock.</p>
          </div>
          <div class="bg-[#171313] p-4 rounded-xl border border-[#8B31FF]/30">
            <h3 class="font-bold text-[#8B31FF] mb-2">RAM Overclocking</h3>
            <p class="text-sm text-gray-400">Ative XMP/DOCP e ajuste manualmente os tempos (timings) para maior estabilidade e performance.</p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400 leading-relaxed">A otimização da rede é crucial para jogos online, especialmente em títulos competitivos onde milissegundos contam. Existem várias configurações que podem reduzir o ping e melhorar a estabilidade da conexão.</p>
        ...
        <p class="mb-4 text-gray-400 leading-relaxed">Além das configurações de protocolo TCP/IP, o Windows tem recursos específicos que podem ser ajustados:</p>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
          <div class="bg-[#1E1E22] p-4 rounded-lg border border-blue-500/30">
            <h3 class="font-bold text-blue-400 mb-2">QoS Packet Scheduler</h3>
            <p class="text-sm text-gray-400">Desative o QoS para permitir que jogos utilizem toda a largura de banda disponível:</p>
          ...
          <div class="bg-[#1E1E22] p-4 rounded-lg border border-green-500/30">
            ...
            <p class="text-sm text-gray-400">Ajuste a prioridade de processos de rede para minimizar atrasos:</p>
        ...
        <p class="mb-4 text-gray-400 leading-relaxed">O hardware também pode ser otimizado para melhor desempenho de rede:</p>
        ...
        <ul class="space-y-3">
          <li class="flex items-start gap-3 p-3 bg-[#1A1A1A] rounded-lg border border-gray-700">
            ...
            <div>
              ...
              <p class="text-sm text-gray-400">Configure prioridade para tráfego de jogo nas configurações da placa de rede</p>
            </div>
          </li>
          <li class="flex items-start gap-3 p-3 bg-[#1A1A1A] rounded-lg border border-gray-700">
            <span class="text-green-400 mt-1">✓</span>
            <div>
              ...
              <p class="text-sm text-gray-400">Ative o modo de jogo se seu roteador suportar para priorizar dispositivos de jogo</p>
            </div>
          </li>
          <li class="flex items-start gap-3 p-3 bg-[#1A1A1A] rounded-lg border border-gray-700">
            <span class="text-green-400 mt-1">✓</span>
            <div>
              ...
              <p class="text-sm text-gray-400">Para conexões Wi-Fi, habilite WMM para priorizar tráfego de áudio/vídeo/jogo</p>
            </div>
          </li>
        </ul>
      `,
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400 leading-relaxed">Diferentes gêneros de jogos têm requisitos e otimizações específicas. Entender essas diferenças permite ajustar o sistema para extrair o máximo de performance em cada tipo de jogo.</p>
        ...
        <div class="bg-gradient-to-r from-indigo-900/20 to-cyan-900/20 p-6 rounded-xl border border-indigo-500/30 mt-8">
          ...
          <p class="text-gray-400 mb-4">Para diferentes gêneros, configure perfis específicos no painel de controle da GPU:</p>
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-400 leading-relaxed">A indústria de jogos está constantemente evoluindo, e novas tecnologias estão surgindo para melhorar o desempenho e a experiência do jogador. Entender essas tendências ajuda a preparar seu sistema para o futuro e tirar proveito das próximas inovações.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div class="bg-gradient-to-br from-teal-900/30 to-emerald-900/20 p-5 rounded-xl border border-teal-500/40">
            ...
            <p class="text-sm text-gray-400 mb-3">Sistemas de IA estão sendo desenvolvidos para otimizar automaticamente configurações de jogo em tempo real:</p>
          ...
          <div class="bg-gradient-to-br from-amber-900/30 to-orange-900/20 p-5 rounded-xl border border-amber-500/40">
            ...
            <p class="text-sm text-gray-400 mb-3">Novas interfaces e APIs estão sendo desenvolvidas para reduzir latência e aumentar eficiência:</p>
            <ul class="space-y-2 text-xs text-gray-400">
        ...
        <p class="mb-4 text-gray-400 leading-relaxed">Para se preparar para essas mudanças, considere estas estratégias de longo prazo:</p>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
          <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
            <h3 class="font-bold text-white mb-2">Hardware Flexível</h3>
            <p class="text-sm text-gray-400">Escolha componentes com boa capacidade de upgrade e suporte a futuras tecnologias.</p>
          </div>
          <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
            <h3 class="font-bold text-white mb-2">Sistema Modular</h3>
            <p class="text-sm text-gray-400">Configure seu sistema de forma modular para facilitar atualizações e experimentação.</p>
          </div>
          <div class="bg-[#1A1A1A] p-4 rounded-lg border border-gray-700">
            <h3 class="font-bold text-white mb-2">Conhecimento Atualizado</h3>
            <p class="text-sm text-gray-400">Mantenha-se informado sobre novas tecnologias e como elas afetam a otimização de jogos.</p>
          </div>
        </div>
      `,
    }
