...
export default function PhishingGuide() {
  ...
  const contentSections = [
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Nunca confie no texto azul de um link. Confie para onde ele aponta:</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-sm text-gray-700 mb-2"><code>https://www.paypal.com/login</code></p>
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-sm text-gray-700 mb-2"><code>https://www.pay-pal-security-update.xyz/login</code></p>
            <ul class="text-sm text-gray-700 space-y-1">
        ...
        <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-500/20 mb-6">
          ...
          <table class="min-w-full bg-gray-800/50 rounded-lg overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-700">
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Hover Test</td>
                <td class="py-2 px-4 text-sm text-gray-700">Passar mouse sobre o link para ver URL real</td>
                <td class="py-2 px-4 text-sm text-green-400">Alta (Desktop)</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">URL Decoder</td>
                <td class="py-2 px-4 text-sm text-gray-700">Ferramentas para decodificar URLs encurtadas</td>
                <td class="py-2 px-4 text-sm text-green-400">Alta</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Certificado SSL</td>
                <td class="py-2 px-4 text-sm text-gray-700">Verificar se o site tem certificado válido</td>
                <td class="py-2 px-4 text-sm text-yellow-400">Média (Pode ser falso)</td>
              </tr>
              <td class="py-2 px-4 text-sm text-gray-700 font-medium">WHOIS Lookup</td>
                <td class="py-2 px-4 text-sm text-gray-700">Verificar informações de registro do domínio</td>
                <td class="py-2 px-4 text-sm text-green-400">Alta</td>
              </tr>
            </tbody>
          </table>
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Verifique se o remetente declarado coincide com o endereço real.</p>
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Mostra o caminho que o e-mail percorreu até chegar a você.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Protocolos de autenticação de e-mail que ajudam a validar a origem.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
        ...
        <div class="bg-green-900/20 p-4 rounded-lg border-l-4 border-green-500 my-6">
          ...
          <p class="text-gray-700 mt-2">Existem ferramentas online que analisam os cabeçalhos de e-mail e verificam a autenticidade, como o MXToolbox, Mail-Tester e E-Mail Header Analyzer. Essas ferramentas podem ajudar a identificar e-mails fraudulentos.</p>
        </div>
      `
    },
    {
          ...
          <table class="min-w-full bg-gray-800/50 rounded-lg overflow-hidden">
            <thead class="bg-gray-700">
              <tr>
                ...
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-700">Característica Legítima</th>
                <th class="py-2 px-4 text-left text-sm font-semibold text-gray-700">Característica Fraudulenta</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-700">
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Layout e Design</td>
                <td class="py-2 px-4 text-sm text-gray-700">Consistente em todas as páginas</td>
                <td class="py-2 px-4 text-sm text-gray-700">Pequenas inconsistências ou qualidade inferior</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Ícones e Logotipos</td>
                <td class="py-2 px-4 text-sm text-gray-700">Imagens de alta resolução e alinhamento perfeito</td>
                <td class="py-2 px-4 text-sm text-gray-700">Imagens pixeladas ou levemente distorcidas</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Campos de Login</td>
                <td class="py-2 px-4 text-sm text-gray-700">Campos bem posicionados e funcionais</td>
                <td class="py-2 px-4 text-sm text-gray-700">Campos mal posicionados ou campos extras</td>
              </tr>
              <tr>
                <td class="py-2 px-4 text-sm text-gray-700 font-medium">Rodapé e Links</td>
                <td class="py-2 px-4 text-sm text-gray-700">Links para políticas, termos e contatos</td>
                <td class="py-2 px-4 text-sm text-gray-700">Links ausentes ou direcionando para domínios diferentes</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Técnicas específicas usadas nestas plataformas.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Táticas usadas para contornar filtros de spam.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Estratégias para explorar a urgência e o medo do cliente.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
        ...
        <div class="bg-yellow-900/20 p-4 rounded-lg border-l-4 border-yellow-500 my-6">
          ...
          <p class="text-gray-700 mt-2">Cada plataforma tem recursos de segurança específicos. Por exemplo, no Discord, verifique se o servidor tem verificação adequada e membros reais. Nos serviços de e-mail, habilite autenticação de dois fatores e verifique regularmente dispositivos conectados.</p>
        </div>
      `
    },
    {
      ...
      content: `
        ...
        <div class="space-y-4 mb-6">
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Ferramentas para analisar a segurança de URLs.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Extensões que ajudam a identificar e bloquear tentativas de phishing.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
          ...
          <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
            ...
            <p class="text-gray-700 text-sm mb-2">Aplicativos que ajudam a verificar a segurança de links e sites.</p>
            <ul class="text-sm text-gray-700 ml-5 space-y-1 list-disc">
  ...
  const faqItems = [
    {
      ...
      answer: `
        <p class="text-gray-700 mb-2">Phishing é uma técnica de fraude cibernética que visa obter informações pessoais e financeiras de usuários por meio de mensagens fraudulentas que simulam instituições legítimas. Os criminosos criam e-mails, sites ou mensagens que parecem confiáveis para induzir as vítimas a fornecer dados sensíveis como senhas, números de cartão de crédito e informações pessoais.</p>
        <p class="text-gray-700">Em 2026, os ataques de phishing utilizam inteligência artificial para criar mensagens altamente personalizadas e convincentes, tornando-os mais difíceis de identificar.</p>
      `
    },
    {
      question: "Como posso identificar um e-mail de phishing?",
      answer: `
        <p class="text-gray-700 mb-2">Sinais comuns de e-mails de phishing incluem:</p>
        ...
        <p class="text-gray-700">Em 2026, os e-mails de phishing são mais sofisticados, por isso é importante verificar cuidadosamente os cabeçalhos e os domínios dos links.</p>
      `
    },
    {
      question: "O que é quishing e como me proteger?",
      answer: `
        <p class="text-gray-700 mb-2">Quishing é phishing realizado por meio de QR Codes (Quick Response). Em 2026, os criminosos enviam QR Codes por e-mail ou mensagens que direcionam para sites de phishing. O objetivo é levar você do seu PC (com proteções) para o celular (onde é mais difícil verificar a segurança).</p>
        <p class="text-gray-700">Para se proteger, nunca escaneie QR Codes de origens não solicitadas, mesmo que pareçam promessas de brindes ou avisos de segurança. Use scanners de QR Code que mostrem a URL antes de abrir.</p>
      `
    },
    {
      question: "Como posso verificar se um site é seguro antes de inserir minhas credenciais?",
      answer: `
        <p class="text-gray-700 mb-2">Para verificar a segurança de um site:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">O melhor método é digitar o URL manualmente em vez de clicar em links de origem duvidosa.</p>
      `
    },
    {
      question: "O que é um ataque de homograph e como evitá-lo?",
      answer: `
        <p class="text-gray-700 mb-2">Um ataque de homograph (ou IDN spoofing) utiliza caracteres Unicode que parecem idênticos aos caracteres ASCII normais, mas são diferentes. Por exemplo, a letra cirílica "а" parece idêntica ao nosso "a", mas são caracteres diferentes.</p>
        <p class="text-gray-700">Para evitar, digite manualmente os URLs de sites importantes, use bookmarks confiáveis e instale extensões que destaquem domínios suspeitos. Verifique o certificado SSL para ver os domínios válidos.</p>
      `
    },
    {
      question: "Como analisar os cabeçalhos de um e-mail para identificar phishing?",
      answer: `
        <p class="text-gray-700 mb-2">Para analisar cabeçalhos de e-mail:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">Esses campos podem revelar se o e-mail foi enviado de um servidor não autorizado ou se foi falsificado.</p>
      `
    },
    {
      question: "Quais são as técnicas de phishing em plataformas específicas como Discord ou redes sociais?",
      answer: `
        <p class="text-gray-700 mb-2">Em plataformas como Discord, os criminosos usam:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
          <li>Golpes do "Nitro grátis" com links para "resgate" de benefícios</li>
          <li>Convites para servidores falsos que simulam concursos ou promoções</li>
          <li>DMs de "moderadores" solicitando verificação de conta</li>
        ...
        <p class="text-gray-700">Nas redes sociais, há perfis falsos compartilhando links fraudulentos e anúncios enganosos. Sempre verifique a autenticidade de contas e links antes de interagir.</p>
      `
    },
    {
      question: "Quais ferramentas posso usar para verificar a segurança de um link ou site?",
      answer: `
        <p class="text-gray-700 mb-2">Ferramentas úteis para verificação de segurança incluem:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">Essas ferramentas ajudam a identificar sites maliciosos antes de visitá-los.</p>
      `
    },
    {
      question: "O que devo fazer se clicar acidentalmente em um link de phishing?",
      answer: `
        <p class="text-gray-700 mb-2">Se clicar acidentalmente em um link de phishing:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">Mesmo que não tenha inserido informações, é prudente monitorar suas contas por alguns dias após o incidente.</p>
      `
    },
    {
      question: "Como posso proteger meus familiares e amigos contra phishing?",
      answer: `
        <p class="text-gray-700 mb-2">Para proteger seus familiares e amigos:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">A educação e conscientização são as melhores defesas contra o phishing.</p>
      `
    },
    {
      question: "Quais são as consequências de cair em um golpe de phishing?",
      answer: `
        <p class="text-gray-700 mb-2">As consequências de cair em um golpe de phishing podem incluir:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">Em casos empresariais, pode resultar em vazamento de dados de clientes e perdas financeiras significativas.</p>
      `
    },
    {
      question: "Como as empresas podem prevenir ataques de phishing internos?",
      answer: `
        <p class="text-gray-700 mb-2">As empresas podem prevenir ataques de phishing internos:</p>
        <ul class="list-disc list-inside text-gray-700 space-y-1 mb-2">
        ...
        <p class="text-gray-700">A combinação de tecnologia e educação é essencial para uma defesa eficaz contra phishing corporativo.</p>
      `
    }
  ];
