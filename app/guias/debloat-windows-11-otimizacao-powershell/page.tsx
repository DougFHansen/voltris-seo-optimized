                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-grow text-center md:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="https://github.com/DougFHansen/voltris-releases/releases/download/v1.8/VoltrisOptimizerInstaller.exe" className="px-8 py-4 bg-[#31A8FF] text-white font-bold rounded-xl hover:bg-[#2b93df] transition-all shadow-[0_0_30px_rgba(49,168,255,0.4)] flex items-center justify-center gap-2">
                                    Baixar Agora (x64)
