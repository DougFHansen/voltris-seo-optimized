...
export default function LimpezaComputadorGuide() {
  ...
  const contentSections = [
        ...
        <div class="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-6 rounded-xl border border-blue-500/30 mt-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-black/30 p-4 rounded-lg">
              ...
              <p class="text-gray-700">Computadores não mantidos acumulam 10-30GB de arquivos temporários em 6 meses</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h4 class="font-bold text-purple-400 mb-2">Performance</h4>
              <p class="text-gray-700">Sistemas bem mantidos mantêm 85-95% da performance original</p>
            </div>
            <div class="bg-black/30 p-4 rounded-lg">
              <h4 class="font-bold text-green-400 mb-2">Custos</h4>
              <p class="text-gray-700">Manutenção preventiva reduz custos com substituição em até 60%</p>
            </div>
          </div>
        </div>
      `,
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Antes de iniciar a limpeza, é importante entender quais arquivos podem ser removidos com segurança e quais devem ser mantidos:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">CCleaner é uma das ferramentas mais populares para limpeza de sistemas Windows, oferecendo uma interface amigável e recursos avançados:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Além do CCleaner, existem outras excelentes opções gratuitas e ferramentas nativas do Windows para limpeza de computadores:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">A desinstalação de programas desnecessários é uma parte crucial da limpeza profunda do computador:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">A otimização do disco é essencial para manter o desempenho do sistema, especialmente em discos mecânicos:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Técnicas avançadas para uma limpeza mais profunda do sistema operacional:</p>
      `,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `
        <p class="mb-4 text-gray-700">Soluções para problemas frequentes que podem ocorrer durante ou após a limpeza do computador:</p>
      `,
      subsections: [
        {
          ...
          content: `
            <div class="space-y-4">
              <div class="bg-[#171313] p-4 rounded-lg border border-red-500/30">
                ...
                <p class="text-gray-700 text-sm mb-2">Solução:</p>
          ...
          content: `
            <div class="space-y-4">
              <div class="bg-[#171313] p-4 rounded-lg border border-purple-500/30">
                ...
                <p class="text-gray-700 text-sm mb-2">Causa Provável:</p>
                ...
                <p class="text-gray-700 text-sm">Solução: Normalize após algumas horas de uso. Os programas irão reconstruir caches automaticamente.</p>
              </div>
              ...
              <div class="bg-[#171313] p-4 rounded-lg border border-blue-500/30">
                ...
                <p class="text-gray-700 text-sm mb-2">Causa:</p>
                <ul class="text-gray-700 text-xs space-y-1 ml-4 mb-2">
                ...
                <p class="text-gray-700 text-sm">Solução: Faça login novamente nos sites importantes. Considere desmarcar "Cookies" em limpezas futuras se quiser manter logins salvos.</p>
              </div>
              ...
              <div class="bg-[#171313] p-4 rounded-lg border border-green-500/30">
                ...
                <p class="text-gray-700 text-sm">Solução: Restaure o sistema a partir de um ponto de restauração criado antes da limpeza.</p>
              </div>
            </div>
          `
        },
