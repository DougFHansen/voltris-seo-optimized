    ...
    const contentSections = [
        ...
        <div class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div class="bg-gray-800 p-4 rounded-lg border-l-4 border-green-500">
                    ...
                    <span class="text-gray-700 text-sm">Iniciar/Parar gravação instantânea (Sem menus).</span>
                </div>
                <div class="bg-gray-800 p-4 rounded-lg border-l-4 border-blue-500">
                    <strong class="text-blue-400 block mb-1">Win + Alt + G</strong>
                    <span class="text-gray-700 text-sm">Salvar os últimos 30 segundos (Clip de Replay).</span>
                </div>
                <div class="bg-gray-800 p-4 rounded-lg border-l-4 border-purple-500">
                    <strong class="text-purple-400 block mb-1">Win + G</strong>
                    <span class="text-gray-700 text-sm">Abrir o Painel (Overlay) para ajustar volumes.</span>
                </div>
            </div>
            ...
            <ol class="list-decimal list-inside text-gray-700 space-y-2 bg-gray-900/40 p-5 rounded-lg">
      ...
      `
        },
        {
            ...
            content: `
        <p class="text-gray-700 mb-4 h-full">
