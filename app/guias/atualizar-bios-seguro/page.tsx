        ...
        <div class="space-y-4">
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-700">Universidade de Cambridge está desenvolvendo métodos para verificação remota da integridade do firmware, com implementação prevista para 2027-2029. Isso permitirá que servidores verifiquem remotamente se clientes têm firmware íntegro.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-700">Microsoft Research está trabalhando em firmware capaz de detectar e reparar automaticamente modificações maliciosas, com testes iniciais previstos para 2026-2027. O firmware seria capaz de restaurar cópias íntegras de si mesmo.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-700">IBM e Intel estão colaborando em firmware resistente a ataques quânticos, com algoritmos de assinatura quântica-resistente integrados ao processo de inicialização. Implementação esperada para 2028-2030.</p>
            </div>
          </div>
        </div>
