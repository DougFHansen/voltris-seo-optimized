  ...
  const contentSections = [
    {
      ...
      content: `
        <p class="mb-4">Este guia apresenta uma abordagem completa e profissional para dominar guia completo de configuração de rede doméstica. 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
          ...
          <div class="bg-[#171313] p-4 rounded-lg border border-[#FF4B6B]/30">
            ...
            <ul class="text-gray-300 text-sm space-y-1">
              ...
              <li>⏱️ Tempo estimado: 80 minutos</li>
