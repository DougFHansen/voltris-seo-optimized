    ...
    const contentSections = [
      ...
      `
        ...
        <ul class="space-y-4 text-gray-600">
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Scan Throttling:** Diminui a prioridade de CPU do processo <code>MsMpEng.exe</code> durante jogos detectados.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Auto-Trust Logic:** Identifica automaticamente os principais lançamentos do mercado e adiciona exclusões seguras.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Malware Guard:** Protege contra ransomware em pastas críticas de documentos e fotos de forma inteligente.</li>
        </ul>
      `
        }
    ];
