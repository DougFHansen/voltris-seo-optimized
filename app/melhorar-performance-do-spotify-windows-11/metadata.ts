...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.voltris.com.br/melhorar-performance-do-spotify-windows-11' },
  openGraph: {
    title: 'Música Sem Lag: Otimize o Spotify para Jogar Sem Perder FPS',
    description: 'Ouça suas playlists sem perder um frame sequer. Configure o Spotify do jeito certo no Windows 11.',
    type: 'article',
    url: 'https://www.voltris.com.br/melhorar-performance-do-spotify-windows-11',
    images: [{ url: '/images/og-spotify-optimization.jpg' }],
  },
};
