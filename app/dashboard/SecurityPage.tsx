      ...
      <div className={`p-8 sm:p-10 rounded-[2.5rem] border overflow-hidden relative group ${transparencyMode ? 'voltris-glass' : 'bg-white border-gray-200 shadow-xl'}`}>
        ...
        <div className="relative z-10 space-y-8">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            {activeFactor && (
              <div className="px-4 py-2 rounded-full bg-emerald-100 border border-emerald-200 text-emerald-700 flex items-center gap-2">
              ...
              {activeFactor ? (
                <>
                  ...
                  <button 
                    ...
                    className="text-red-600/50 hover:text-red-600 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all"
                  >
