...
export default function DesativarVBS() {
    ...
    const contentSections = [
        ...
        <div class="bg-red-100 border border-red-200 p-6 rounded-2xl my-6">
            <h4 class="text-red-700 font-black mb-2 flex items-center gap-2">Alerta de Hardware</h4>
      ...
      `
        ...
        <ul class="space-y-4 text-gray-600">
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **VBS Direct Disable:** Desliga o recurso sem precisar formatar ou mexer na BIOS.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Hypervisor Off:** Descarrega os drivers de virtualização que os jogos não utilizam.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Gaming Affinity:** Garante que os processos de jogo utilizem todos os núcleos reais da CPU sem as 'barreiras' de segurança virtual.</li>
        </ul>
      `
        }
    ];
