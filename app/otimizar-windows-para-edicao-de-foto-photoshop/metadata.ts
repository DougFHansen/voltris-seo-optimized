...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.voltris.com.br/otimizar-windows-para-edicao-de-foto-photoshop' },
  openGraph: {
    title: 'Edição Sem Limites: Otimize seu PC para Photoshop e Lightroom',
    description: 'Filtros instantâneos e exportação rápida. Transforme seu Windows para o fluxo criativo profissional.',
    type: 'article',
    url: 'https://www.voltris.com.br/otimizar-windows-para-edicao-de-foto-photoshop',
    images: [{ url: '/images/og-photoshop-optimization.jpg' }],
  },
};
