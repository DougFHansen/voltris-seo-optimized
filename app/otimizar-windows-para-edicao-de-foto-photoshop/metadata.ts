...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://voltris.com.br/otimizar-windows-para-edicao-de-foto-photoshop' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://voltris.com.br/otimizar-windows-para-edicao-de-foto-photoshop',
