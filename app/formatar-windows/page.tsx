  ...
  return (
    <>
      ...
      <JsonLd
        type="Service"
        data={{
          name: "Formatação de Windows Profissional e Otimizada",
          description: "Instalação limpa de Windows 10 e Windows 11 com backup, instalação de drivers e otimização de performance para jogos e trabalho.",
          provider: {
            "@type": "Organization",
            "name": "VOLTRIS",
            "url": "https://voltris.com.br"
          },
          serviceType: "Informática",
      ...
      <div className="min-h-screen bg-[#050510] text-white">
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 brightness-100 contrast-150 mix-blur-overlay pointer-events-none"></div>
          <div className="max-w-6xl mx-auto relative z-10">
