...
export default function ServicosClient() {
    ...
    return (
        <div className="relative w-full overflow-x-hidden bg-[#050510] text-slate-200 selection:bg-[#31A8FF]/30">
            <Header />

            {/* Hero Section */}
            <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 lg:pt-40 pb-20 px-4 overflow-hidden">
                <TechFloatingElements />

                {/* Background Ambience */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#31A8FF]/5 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow max-w-full"></div>
                    <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-[#8B31FF]/5 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow max-w-full"></div>
                    <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 hidden md:block mix-blend-overlay"></div>
                </div>
            ...
            <section id="servicos-lista" className="py-24 px-4 bg-[#0A0A0F] relative z-10">
            ...
            <section className="py-24 px-4 border-t border-white/5 bg-[#050510] relative overflow-hidden">
