...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.voltris.com.br/todos-os-servicos/criacao-sites/plano-empresarial'
    },
    openGraph: {
        title: 'Plano Empresarial - Sites Corporativos de Alto Nível | VOLTRIS',
        description: 'Solução completa para grandes empresas com suporte dedicado 24/7.',
        url: 'https://www.voltris.com.br/todos-os-servicos/criacao-sites/plano-empresarial',
        type: 'website',
        locale: 'pt_BR',
        siteName: 'VOLTRIS',
