...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://voltris.com.br/todos-os-servicos/criacao-sites/plano-profissional'
    },
    openGraph: {
        title: 'Plano Profissional - Criação de Sites Avançados | VOLTRIS',
        description: 'Site completo com funcionalidades avançadas e suporte premium.',
        url: 'https://voltris.com.br/todos-os-servicos/criacao-sites/plano-profissional',
        type: 'website',
        locale: 'pt_BR',
        siteName: 'VOLTRIS',
