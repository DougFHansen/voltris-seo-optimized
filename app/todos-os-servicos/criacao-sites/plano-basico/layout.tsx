...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.voltris.com.br/todos-os-servicos/criacao-sites/plano-basico'
    },
    openGraph: {
        title: 'Plano Básico - Criação de Sites Profissionais | VOLTRIS',
        description: 'Site profissional, responsivo e otimizado para SEO. Ideal para pequenos negócios.',
        url: 'https://www.voltris.com.br/todos-os-servicos/criacao-sites/plano-basico',
        type: 'website',
        locale: 'pt_BR',
        siteName: 'VOLTRIS',
