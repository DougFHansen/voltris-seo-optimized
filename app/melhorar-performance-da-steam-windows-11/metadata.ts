...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.voltris.com.br/melhorar-performance-da-steam-windows-11' },
  openGraph: {
    title: 'Steam Veloz: Otimize o Launcher para Jogar Mais Rápido',
    description: 'Abertura instantânea e downloads acelerados. Libere o potencial total da Steam no Windows 11.',
    type: 'article',
    url: 'https://www.voltris.com.br/melhorar-performance-da-steam-windows-11',
    images: [{ url: '/images/og-steam-optimization.jpg' }],
  },
};
