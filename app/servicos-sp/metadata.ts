...
export const metadata: Metadata = {
  ...
  keywords: [
    'serviços técnicos sp',
    'formatação windows sp',
    'otimização pc sp',
    'assistência técnica sp',
    'conserto computador sp',
    'manutenção pc sp',
    'otimização computador sp',
    'formatação notebook sp',
    'assistência informática sp',
    'manutenção computador sp',
    'suporte técnico sp',
    'reparo pc sp',
    'serviços tecnológicos sp',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Serviços Técnicos em São Paulo - Formatação e Otimização'
    }]
  }
};
