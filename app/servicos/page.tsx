  ...
  return (
    <div className="min-h-screen bg-[#020205] text-white font-sans selection:bg-blue-500/30">
      ...
      <JsonLd
        type="Service"
        data={{
          name: "Otimização de PC Gamer e Suporte Técnico de TI",
          serviceType: "IT Support and PC Optimization",
          description: "Serviços profissionais de otimização de computadores Windows para jogos (FPS tuning) e suporte técnico especializado (formatação, instalação de programas, consultoria) 100% remoto.",
          provider: {
            "@type": "Organization",
            "name": "VOLTRIS",
        ...
        data={{
          itemListElement: [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Serviços",
              "item": "https://www.voltris.com.br/servicos"
            }
          ]
        }}
      />
