        ...
        {formattingAnswers.bootNormally === true && (
          <div className="space-y-2 transition-all duration-300 ease-in-out animate-fadeIn">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-gray-300 text-lg">A tela de inicialização mostra o logo do fabricante?</p>
            </div>
            <div className="flex gap-3">
              <button
        ...
        {formattingAnswers.showsLogo === true && (
          <div className="space-y-2 transition-all duration-300 ease-in-out animate-fadeIn">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-gray-300 text-lg">Você consegue acessar o Windows e a internet?</p>
            </div>
            <div className="flex gap-3">
              <button
                onClick={() => {
        ...
        {formattingAnswers.hasWindows === false && formattingAnswers.hasInternet === false && (
          <div className="space-y-2 transition-all duration-300 ease-in-out animate-fadeIn mt-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-gray-300 text-lg">Você tem acesso a um pen drive e outro computador?</p>
            </div>
      ...
      <AnimatedSection>
        <div className="py-20 relative">
          ...
          <div className="text-center mb-16 relative z-10">
            <span className="text-[#31A8FF] font-bold tracking-widest uppercase text-xs sm:text-sm mb-2 block">Fluxo de Trabalho</span>
        ...
        <div className="py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#31A8FF] to-[#8B31FF]">Gera Resultados.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { icon: FiShield, title: "Garantia Total", desc: "Suporte pós-serviço incluído.", color: "text-[#8B31FF]", bg: "bg-[#8B31FF]/10", border: "border-[#8B31FF]/20" },
              { icon: FiUsers, title: "Especialistas Reais", desc: "Equipe sênior certificada.", color: "text-[#31A8FF]", bg: "bg-[#31A8FF]/10", border: "border-[#31A8FF]/20" },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="text-center">
                <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">
                  <span className="text-[#e2e8f0]">Serviços Técnicos</span> <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#31A8FF] to-[#8B31FF]">Profissionais</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                  <button
                    ...
                    className="px-8 py-4 bg-white text-[#050510] font-bold rounded-xl hover:bg-[#F3F4F6] transition-all shadow-[0_20px_50px_rgba(255,255,255,0.1)] relative overflow-hidden group"
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      Começar Agora <FiArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </span>
                  </button>
                  <Link href="/contato" className="px-8 py-4 border border-white/20 text-white font-bold rounded-xl hover:bg-white/10 transition-all flex items-center justify-center gap-2">
