                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="bg-[#0A0A0E]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                                ...
                                <div className="text-left space-y-6">
                                    ...
                                    <ul className="space-y-4">
                                        <li className="flex items-start gap-3 text-sm text-slate-300">
                                            ...
                                            <span>Chave de Ativação <strong>Premium</strong></span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-slate-300">
                                            <CheckCircle2 className="w-4 h-4 text-[#31A8FF] mt-0.5 shrink-0" />
                                            <span>Acesso a todas as features (FPS Boost, Rede, Input Lag)</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-slate-300">
                                            <CheckCircle2 className="w-4 h-4 text-[#31A8FF] mt-0.5 shrink-0" />
                                ...
                                {/* Lado Direito: CTA */}
                                <div className="flex flex-col items-center justify-center space-y-6 bg-white/[0.03] p-6 rounded-2xl border border-white/5">
                                    <div className="text-center">
                                        <span className="text-xs text-slate-500 uppercase tracking-widest font-bold">Atendimento Personalizado</span>
                                    </div>

                                    <a
                                        href="https://wa.me/5511996716235?text=Olá,%20gostaria%20de%20adquirir%20uma%20licença%20do%20Voltris%20Optimizer.%20Poderiam%20me%20passar%20os%20planos%20e%20formas%20de%20pagamento?"
                                        target="_blank"
                                    ...
                                    <div className="text-center space-y-2">
                                        <p className="text-xs text-slate-400 font-medium">
                                            <span className="text-[#31A8FF] flex items-center justify-center gap-1">
                                                <Server className="w-3 h-3" />
                                                Checkout automático em manutenção
                                            </span>
                                            Para sua segurança, as vendas estão sendo processadas manualmente pelo nosso time comercial.
                                        </p>
                            ...
                            <div className="mt-8 pt-6 border-t border-white/5 flex flex-wrap justify-between items-center gap-4">
                                <div className="flex items-center gap-4 text-xs text-slate-500 font-medium">
                                    ...
                                    <span className="flex items-center gap-1.5"><MessageSquare className="w-4 h-4 text-[#31A8FF]" /> Suporte Humano</span>
                                    <span className="flex items-center gap-1.5"><Cpu className="w-4 h-4 text-[#FF4B6B]" /> Software Verificado</span>
                                </div>
