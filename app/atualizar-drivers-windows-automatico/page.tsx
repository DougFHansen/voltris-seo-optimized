    ...
    const contentSections = [
      ...
      `
        ...
        <ul class="space-y-4 text-gray-600">
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Verified Drivers:** Baixamos drivers direto das fontes oficiais (OEM) sem intermediários duvidosos.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **Safe Backup:** Um Clique para salvar os drivers atuais antes do novo update. Se algo der errado, você volta em segundos.</li>
            <li class="flex items-start gap-3"><div class="w-2 h-2 rounded-full bg-blue-600 mt-1.5 shrink-0"></div> **DDU Integration:** Remova resíduos de drivers antigos de vídeo de forma profissional (Deep Cleanup).</li>
        </ul>
      `
        }
    ];
