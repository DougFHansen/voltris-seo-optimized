...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'combo assistência técnica',
    'pacote formatação otimização',
    'serviços combinados pc',
    'pacotes tech',
    'formatação windows otimização',
    'serviços técnicos combinados',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Pacotes de Serviços Técnicos Combinados'
    }]
  }
};
