...
const services = [
  {
    id: "formatacao",
    title: "Formatação de Computador em Casa",
    description: "Formatação completa no conforto da sua casa.",
    ...
    redirect: "/formatacao",
    buttonText: "Formatar PC em Casa"
  },
  {
    id: "otimizacao",
    title: "Otimização de PC em Casa",
    description: "Otimização remota completa do seu computador para melhor desempenho, sem sair de casa.",
    ...
    buttonText: "Otimizar PC em Casa"
  },
  {
    id: "remocao-virus",
    title: "Remoção de Vírus em Casa",
    description: "Remoção remota de vírus e proteção do seu computador, sem deslocamento.",
    ...
    buttonText: "Remover Vírus em Casa"
  },
  {
    id: "instalacao-programas",
    title: "Instalação de Programas em Casa",
    description: "Instalação e configuração remota de programas essenciais para seu computador, direto de casa.",
    ...
    buttonText: "Ver programas em Casa"
  },
  {
    id: "recuperacao",
    title: "Recuperação De Dados em Casa",
    description: "Recuperação remota de dados e arquivos importantes do seu computador, sem sair de casa.",
    ...
    buttonText: "Recuperar Dados em Casa"
  },
  {
    id: "impressora",
    title: "Instalação de Impressora em Casa",
    description: "Instalação remota de drivers e configuração de impressoras no seu computador, direto de casa.",
    ...
    buttonText: "Instalar Impressora em Casa"
  }
];
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Técnico de <span className="text-[#31A8FF]">Informática</span> em Casa VOLTRIS
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto">
              Suporte técnico remoto e presencial no conforto da sua casa. Resolva problemas de computador, formatação, otimização e manutenção de sistemas Windows sem sair de casa.
            </p>
          </div>
