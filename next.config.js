  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://assets.pagseguro.com.br https://sandbox.assets.pagseguro.com.br https://www.googletagmanager.com https://www.google-analytics.com",
            "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
            "font-src 'self' https://fonts.gstatic.com",
            "img-src 'self' data: blob: https: http:",
            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.pagseguro.com https://sandbox.api.pagseguro.com https://www.google-analytics.com",
            "frame-src 'self' https://assets.pagseguro.com.br https://sandbox.assets.pagseguro.com.br",
            "object-src 'none'",
            "base-uri 'self'",
            "form-action 'self'",
          ].join('; '),
